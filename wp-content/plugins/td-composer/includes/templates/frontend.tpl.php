...
//						),
						...
						if ( isset( $mapped_shortcode['tdc_category'] ) ) {
							switch( $mapped_shortcode['tdc_category'] ) {
                                ...
                                case 'Author page':
                                    ...
                                    break;
                                case 'Date page':
                                    $date_page_mapped_shortcodes[] = $mapped_shortcode;
                                    break;
                                case 'Search page':
					...
					if ( ! empty( $single_post_mapped_shortcodes ) ) {
                    ...
                    if ( ! empty( $category_page_mapped_shortcodes ) ) {
                    ...
                    if ( ! empty( $tag_page_mapped_shortcodes ) ) {
                    ...
                    if ( ! empty( $author_page_mapped_shortcodes ) ) {
                    ...
                    if ( ! empty( $date_page_mapped_shortcodes ) ) {

                        // Separator
                        echo '<div class="tdc-sidebar-separator">Date Page shortcodes</div>';

                        // Here will be displayed the author page shortcodes
                        foreach ( $date_page_mapped_shortcodes as $mapped_shortcode ) {
                    ...
                    if ( ! empty( $search_page_mapped_shortcodes ) ) {
                    ...
                    if ( ! empty( $attachment_page_mapped_shortcodes ) ) {
