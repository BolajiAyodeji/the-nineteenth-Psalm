...
function td_template_include_filter( $wordpress_template_path ) {
	...
	if (is_single() and (($wordpress_template_path == TEMPLATEPATH . '/single.php') or ($wordpress_template_path == STYLESHEETPATH . '/single.php'))) {
        ...
        if (!empty($td_post_theme_settings['td_post_template'])) {
            ...
            if (td_api_single_template::_is_tdb_template($single_template_id)) {

                $tdb_template_id = td_api_single_template::_tdb_get_template_id($single_template_id);
		...
		if (td_api_single_template::_is_tdb_template($default_template_id)) {

		    // load the default tdb template
            $tdb_template_id = td_api_single_template::_tdb_get_template_id($default_template_id);
