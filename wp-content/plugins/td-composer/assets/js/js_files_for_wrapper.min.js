...
!0);else{var f=0;!0!==tdcMain.getSidebarInline()||!1!==tdcMain.getSidebarHidden()||g(a.target).closest("#tdc-sidebar").length||(f=tdcSidebar.$_sidebar.width());var n=tdcAdminIFrameUI.getLiveIframe().width(),d=0;window.innerWidth!==n&&(d=(window.innerWidth-n)/2,!0===tdcMain.getSidebarInline()&&!1===tdcMain.getSidebarHidden()&&(d-=tdcSidebar.$_sidebar.width()/2));g(a.target).closest("#tdc-sidebar").length?d=0:g(a.target).closest("#tdc-live-iframe-wrapper").length&&(d=0,tdcMain.getSidebarInline()&&(d=
-tdcSidebar.$_sidebar.width()));c.css({left:a.clientX-30+f+d,top:a.clientY-22});c.show();tdcOperationUI.deactivateMenu();tdcOperationUI.setLiveIframeCss("tdc-active-helper");a=e.data("shortcodeName");c=e.data("templateContent");b.isUndefined(a)&&b.isUndefined(c)&&(e=e.data("model_id"),a=tdcIFrameData.getModel(e).get("tag"));b.isUndefined(a)||tdcAdminWrapperUI.setHelperClass("tdc-element-ico tdc-ico-"+a);tdcRecycleUI.show()}},hideHelper:function(){tdcAdminWrapperUI.clearHelperClass();tdcAdminWrapperUI.$helper.hide();
...
!b.isUndefined(tdcOperationUI._placeholderCacheCssSettings.props)&&!b.isEqual(tdcOperationUI._placeholderCacheCssSettings.props,c))&&(tdcOperationUI._placeholderCacheCssSettings.props=c,e.css(c))},setHorizontalPlaceholder:function(a){tdcOperationUI.setPlaceholder("",a)},setVerticalPlaceholder:function(a){tdcOperationUI.setPlaceholder("vertical",a)},_moveDraggedElement:function(){var a=tdcOperationUI.getDraggedElement(),c=tdcOperationUI.getCurrentElementOver(),h=tdcAdminWrapperUI.$placeholder,f="";
if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(h)||!h.is(":visible")&&c!==tdcAdminWrapperUI.$recycle)){var n=tdcOperationUI.isSidebarElementDragged(),d=tdcOperationUI.isElementDragged(),k=!1,m=!1,p=!1,q=!1,r=!1,w=!1,u=tdcOperationUI.isElementWithRowDragged(),t=tdcOperationUI.getRowStartValues();if(d){var v=a.closest(".tdc-elements");n||(f=tdcIFrameData._getSourceCol())}else(k=tdcOperationUI.isInnerColumnDragged())&&(v=a.closest(".tdc-inner-columns"));!k&&(m=tdcOperationUI.isInnerRowDragged(),
p=tdcOperationUI.isTempInnerRowDragged(),m||p)&&(v=a.closest(".tdc-elements"));m||p||(q=tdcOperationUI.isColumnDragged())&&(v=a.closest(".tdc-columns"));!q&&(r=tdcOperationUI.isRowDragged(),w=tdcOperationUI.isTempRowDragged(),r||w)&&(v=a.closest("#tdc-rows"));if(n||d||k||m||p||q||r||w){var A="",x=a.find(".td_block_inner");x.length&&(A=x.attr("id"));if(!n&&!b.isUndefined(v)&&v.length){var z=v.children();x=z.index(a);var y=z.index(h);if(c!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(x-y))return;
if(d||m||p||r||w){if((d||m||r)&&c===tdcAdminWrapperUI.$recycle){h="Deleting ";tdConfirm.showModal(m?h+"inner row":r?h+"row":h+"element",tdcOperationUI,function(){if((-1===y&&1===z.length||2===z.length&&-1!==y)&&(!r||1!==tdcIFrameData.tdcRows.length)){var c="";B=a.closest(".tdc-inner-column");B.length?c=" tdc-element-inner-column":(C=a.closest(".tdc-column"),C.length&&(c=" tdc-element-column"));c=g('<div class="'+tdcOperationUI._emptyElementClass+c+'" title="Empty element that should be removed by composer"></div>');
tdcElementUI.bindEmptyElement(c);v.append(c)}tdcOperationUI.setDraggedElement(a);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);tdcIFrameData.changeData({wasSidebarElementDragged:n,wasElementDragged:d,wasInnerColumnDragged:k,wasInnerRowDragged:m,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:r,wasTempRowDragged:w,wasElementWithRowDragged:u,rowStartValues:t,draggedBlockUid:A,sourceColParam:f});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(e);tdcOperationUI.setCurrentElementOver(e);
tb_remove()},e,"Are you sure you want to delete this element?");return}if(-1===y&&1===z.length||2===z.length&&-1!==y){c="";var B=a.closest(".tdc-inner-column");if(B.length)c=" tdc-element-inner-column";else{var C=a.closest(".tdc-column");C.length&&(c=" tdc-element-column")}c=g('<div class="'+tdcOperationUI._emptyElementClass+c+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(c);v.append(c)}}}n&&(c="",d?c="tdc-element":p?c="tdc-element-inner-row-temp":
m?c="tdc-element-inner-row":w?c="tdc-row-temp":r&&(c="tdc-row"),c=g('<div class="'+c+'">'+a.html()+"</div>"),b.isUndefined(a.data("shortcodeName"))||c.data("shortcodeName",a.data("shortcodeName")),b.isUndefined(a.data("startValues"))||c.data("startValues",a.data("startValues")),b.isUndefined(a.data("shortcodeContent"))||c.data("shortcodeContent",a.data("shortcodeContent")),b.isUndefined(a.data("rowStartValues"))||c.data("rowStartValues",a.data("rowStartValues")),b.isUndefined(a.data("templateContent"))||
c.data("templateContent",a.data("templateContent")),tdcOperationUI.setDraggedElement(c),a=tdcOperationUI.getDraggedElement());h.replaceWith(a);if(n||d)B=a.closest(".tdc-inner-column"),B.length?(a.removeClass("tdc-element-column"),a.addClass("tdc-element-inner-column")):(C=a.closest(".tdc-column"),C.length&&(a.removeClass("tdc-element-inner-column"),a.addClass("tdc-element-column")));h=a.prev();h.hasClass(tdcOperationUI._emptyElementClass)&&h.remove();h=a.next();h.hasClass(tdcOperationUI._emptyElementClass)&&
h.remove();tdcIFrameData.changeData({wasSidebarElementDragged:n,wasElementDragged:d,wasInnerColumnDragged:k,wasInnerRowDragged:m,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:r,wasTempRowDragged:w,wasElementWithRowDragged:u,rowStartValues:t,draggedBlockUid:A,sourceColParam:f})}else new tdcNotice.notice("_moveDraggedElement Error: $draggedElement not valid!",!0,!1)}}}})(jQuery,Backbone,_);var tdcRowUI;
...
tdcRowUI.positionRowPlaceholder(a)):tdcMaskUI.setCurrentContainer(e)}).on("fakemouseenterevent",function(c){if(tdcOperationUI.isRowDragged()||tdcOperationUI.isTempRowDragged()){var b=a.outerHeight(!0),e=a.outerWidth(),d=a.offset();parseInt(d.left)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(d.left+e)&&parseInt(d.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(d.top+b)&&(tdcOperationUI.setCurrentElementOver(a),tdcRowUI.positionRowPlaceholder(c))}})},positionRowPlaceholder:function(a,c){var h=
tdcAdminWrapperUI.$placeholder,f=0,d=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)f=a.pageX,d=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){f=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var l={pageX:f,pageY:d};tdcOperationUI.setCurrentElementOver(e);
tdcRowUI.tdcRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&g(c).trigger(g.Event("fakemouseenterevent",l))});return}f=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(f))tdcOperationUI.hidePlaceholder();else{var k=tdcOperationUI.getCurrentElementOverOuterHeight(),m=tdcOperationUI.getCurrentElementOverOuterWidth(),p=tdcOperationUI.getCurrentElementOverOffset();if(d>p.top+k/2){d=f.next();if(!d.length||d.length&&
d.attr("id")!==tdcAdminWrapperUI.placeholderId)f.after(h),tdcOperationUI.updateInfoHelper();parseInt(p.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"",right:"auto",bottom:"0",width:m,"margin-left":""}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"",right:"",bottom:"",width:m,"margin-left":""})}else{d=f.prev();if(!d.length||d.length&&d.attr("id")!==
tdcAdminWrapperUI.placeholderId)f.before(h),tdcOperationUI.updateInfoHelper();parseInt(p.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"",right:"auto",bottom:"",width:m,"margin-left":""}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"",right:"",bottom:"",width:m,"margin-left":""})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcRowUI._elementCssClass}}})(jQuery,
...
tdcColumnUI.positionColumnPlaceholder(c)):(tdcMaskUI.setCurrentContainer(e),c=tdcOperationUI.inRow(a),b.isUndefined(c)||c.mouseenter())}).on("fakemouseenterevent",function(c){if(tdcOperationUI.isColumnDragged(a)){var b=a.find(".tdc-elements:first");if(b.length){var e=b.outerHeight(!0);b=b.outerWidth();var d=a.offset(),l=0,k=a.prevAll("."+tdcColumnUI._elementCssClass);k.length&&k.each(function(a,c){l+=parseInt(g(c).find(".tdc-elements:first").width())});l+=d.left;parseInt(l)<=parseInt(c.pageX)&&parseInt(c.pageX)<=
parseInt(l+b)&&parseInt(d.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(d.top+e)&&(tdcOperationUI.setCurrentElementOver(a),tdcColumnUI.positionColumnPlaceholder(c))}}})},positionColumnPlaceholder:function(a,c){var h=tdcAdminWrapperUI.$placeholder,f=0,d=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)f=a.pageX,d=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===
a.type){f=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var l={pageX:f,pageY:d};tdcOperationUI.setCurrentElementOver(e);tdcOperationUI.getDraggedElement().closest(".tdc-columns").find(".tdc-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&g(c).trigger(g.Event("fakemouseenterevent",l))});return}d=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||
b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var k=d.outerWidth(!0),m=tdcOperationUI.getCurrentElementOverOffset(),p=0,q=d.prevAll();q.length&&q.each(function(a,c){var b=g(c);b.hasClass("tdc-column")&&(p+=parseInt(b.outerWidth(!0)))});q=d.parent(".tdc-columns").parent(".vc_row");var r=q.css("position");if(b.isUndefined(r)||"static"!==r)if(q=q.css("padding-left"),b.isUndefined(q)||(q=parseInt(q.replace("px",""))),f>m.left+k/2){f=d.next();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(h),
tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(p+k+q),"margin-left":-24,top:""})}else{f=d.prev();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(p+q),"margin-left":-24,top:""})}else if(f>m.left+k/2){f=d.next();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(m.left+
k),"margin-left":-24,top:""})}else{f=d.prev();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(m.left),"margin-left":-24,top:""})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcColumnUI._elementCssClass}}})(jQuery,Backbone,_);var tdcInnerRowUI;
...
l))});tdcInnerRowUI.tdcElementInnerRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&g(c).trigger(g.Event("fakemouseenterevent",l))});return}f=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(f))tdcOperationUI.hidePlaceholder();else{var k=f.outerHeight(!0),m=f.innerWidth(),p=f.offset();if(d>p.top+k/2){d=f.next();if(!d.length||d.length&&d.attr("id")!==tdcAdminWrapperUI.placeholderId)f.after(h),tdcOperationUI.updateInfoHelper(e);
parseInt(p.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"","margin-left":"",bottom:"0",width:m}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:m})}else{d=f.prev();if(!d.length||d.length&&d.attr("id")!==tdcAdminWrapperUI.placeholderId)f.before(h),tdcOperationUI.updateInfoHelper(e);parseInt(p.top)<
...
a.find(".tdc-elements:first");if(b.length){var e=b.outerHeight(!0);b=b.outerWidth();var d=a.offset(),l=0,k=a.prevAll("."+tdcInnerColumnUI._elementCssClass);k.length&&k.each(function(a,c){l+=parseInt(g(c).find(".tdc-elements:first").width())});l+=d.left;parseInt(l)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(l+b)&&parseInt(d.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(d.top+e)&&(tdcOperationUI.setCurrentElementOver(a),tdcInnerColumnUI.positionInnerColumnPlaceholder(c))}}})},positionInnerColumnPlaceholder:function(a,
c){var h=tdcAdminWrapperUI.$placeholder,f=0,d=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)f=a.pageX,d=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){f=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var l={pageX:f,pageY:d};tdcOperationUI.setCurrentElementOver(e);
tdcOperationUI.getDraggedElement().closest(".tdc-inner-columns").find(".tdc-inner-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&g(c).trigger(g.Event("fakemouseenterevent",l))});return}d=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var k=d.outerWidth(!0),m=d.offset(),p=0,q=d.prevAll();q.length&&q.each(function(a,c){var b=g(c);b.hasClass("tdc-inner-column")&&(p+=
parseInt(b.outerWidth(!0)))});q=d.parent(".tdc-inner-columns").parent(".vc_row_inner").css("padding-left");q=b.isUndefined(q)?0:parseInt(q.replace("px",""));if(f>m.left+k/2){f=d.next();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(h),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(p+k+q),"margin-left":-24})}else{f=d.prev();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(h),tdcOperationUI.updateInfoHelper();
tdcOperationUI.setVerticalPlaceholder({left:parseInt(p+q),"margin-left":-24})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcInnerColumnUI._elementCssClass}}})(jQuery,Backbone,_);var tdcElementsUI;
...
(function(g,d,b,e){tdcElementUI={_elementCssClass:"tdc-element",_innerColumnGap:10,tdcElements:e,init:function(a){b.isUndefined(a)&&(a=tdcOperationUI.iframeContents);tdcElementUI.tdcElement=a.find("."+tdcElementUI._elementCssClass);tdcElementUI.tdcElement.each(function(a,b){tdcElementUI.bindElement(g(b))})},positionElementPlaceholder:function(a,c){var h={X:0,Y:0};if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)h.X=a.pageX,h.Y=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||
(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){h.X=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;h.Y=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var f={pageX:h.X,pageY:h.Y};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&g(c).trigger(g.Event("fakemouseenterevent",f))});return}var d=tdcOperationUI.getCurrentElementOver();
if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var l=tdcOperationUI.getCurrentElementOverOuterHeight(),k=tdcOperationUI.getCurrentElementOverOuterWidth(),m=tdcOperationUI.getCurrentElementOverOffset(),p=tdcOperationUI.getCurrentElementOverHeight(),q=!1;"inline-block"===d.css("display")&&(q=!0);q?(l=tdcOperationUI.getCurrentElementOverPosition(),q=parseInt(d.css("margin-top")),h.Y>m.top+p/2?(h=tdcElementUI._checkInnerColumnLastElement(h),
b.isUndefined(h.elementOuterWidth)||(k=h.elementOuterWidth),parseInt(m.top)+parseInt(p)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?(m=parseInt(m.left),h.isInnerColumnLastElement&&(d=d.closest(".tdc-element-inner-row"),m=parseInt(d.offset().left)-parseInt(d.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:m,"margin-top":"","margin-left":"",bottom:"0",width:k})):(m=parseInt(l.left),h.isInnerColumnLastElement&&(d=d.closest(".tdc-element-inner-row"),
m=parseInt(d.position().left)+parseInt(d.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:l.top+q+p,left:m,"margin-top":"","margin-left":"",bottom:"",width:k}))):(h=tdcElementUI._checkInnerColumnFirstElement(h),b.isUndefined(h.elementOuterWidth)||(k=h.elementOuterWidth),parseInt(m.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?(m=parseInt(m.left)-parseInt(d.css("margin-left")),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:m,"margin-top":"0",
"margin-left":"",bottom:"",width:k})):(m=parseInt(l.left),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:l.top+q,left:m,"margin-top":"","margin-left":"",bottom:"",width:k})))):h.Y>m.top+p/2?(h=tdcElementUI._checkInnerColumnLastElement(h),b.isUndefined(h.elementOuterWidth)||(k=h.elementOuterWidth),parseInt(m.top)+parseInt(l)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
"margin-left":"",bottom:"0",width:k}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:k})):(h=tdcElementUI._checkInnerColumnFirstElement(h),b.isUndefined(h.elementOuterWidth)||(k=h.elementOuterWidth),parseInt(m.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"","margin-top":"0","margin-left":"",bottom:"",width:k}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",
top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:k}));b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},_checkInnerColumnFirstElement:function(a){var c={isInnerColumnFirstElement:!1},b=tdcAdminWrapperUI.$placeholder,f=tdcOperationUI.getCurrentElementOver(),d=tdcOperationUI.getCurrentElementOverOffset();tdcElementUI.isInnerColumnFirstElement(f)&&a.Y<d.top+tdcElementUI._innerColumnGap&&(c.isInnerColumnFirstElement=!0);if(c.isInnerColumnFirstElement){if(f=
...
l=tdcOperationUI.getCurrentElementOverOffset();tdcElementUI.isInnerColumnLastElement(f)&&a.Y>l.top+d-tdcElementUI._innerColumnGap&&(c.isInnerColumnLastElement=!0);if(c.isInnerColumnLastElement){if(f=f.closest(".tdc-element-inner-row"),c.elementOuterWidth=f.outerWidth(!0),a=f.next(),!a.length||a.length&&a.attr("id")!==tdcAdminWrapperUI.placeholderId)f.after(b),tdcOperationUI.updateInfoHelper(e)}else if(a=f.next(),!a.length||a.length&&a.attr("id")!==tdcAdminWrapperUI.placeholderId)f.after(b),tdcOperationUI.updateInfoHelper(e);
return c},positionEmptyElementPlaceholder:function(a){var c=tdcAdminWrapperUI.$placeholder,h=0,f=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)h=a.pageX,f=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){h=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;f=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var d=
{pageX:h,pageY:f};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&g(c).trigger(g.Event("fakemouseenterevent",d))});return}var l=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(l))tdcOperationUI.hidePlaceholder();else{var k=tdcOperationUI.getCurrentElementOverOuterHeight();a=tdcOperationUI.getCurrentElementOverOuterWidth();h=tdcOperationUI.getCurrentElementOverOffset();
if(f>h.top+k/2){var m=!1;tdcElementUI.isInnerColumnLastElement(l)&&f>h.top+k-tdcElementUI._innerColumnGap&&(m=!0);m?(l=l.closest(".tdc-element-inner-row"),a=l.outerWidth(!0),f=l.next(),f.length||(l.after(c),tdcOperationUI.updateInfoHelper(e))):(f=l.next(),f.length||(l.after(c),tdcOperationUI.updateInfoHelper(e)));parseInt(h.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
"margin-left":"",bottom:0,width:a}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":-50,"margin-left":"",bottom:"",width:a})}else k=!1,tdcElementUI.isInnerColumnFirstElement(l)&&f<h.top+tdcElementUI._innerColumnGap&&(k=!0),k?(l=l.closest(".tdc-element-inner-row"),a=l.outerWidth(!0),f=l.prev(),f.length||(l.before(c),tdcOperationUI.updateInfoHelper(e))):(f=l.prev(),f.length||(l.before(c),tdcOperationUI.updateInfoHelper(e))),parseInt(h.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?
...
!tdcSidebar.mouseOverSidebar)if(tdcMaskUI.$currentElement=a,b.isUndefined(tdcMaskUI.$currentElement))tdcMaskUI.$wrapper.hide(),tdcMaskUI.$content.hide(),tdcMaskUI.$contentFull.hide();else{a=tdcIFrameData.iframeContents.find("#tdc-rows").offset();var c=tdcMaskUI.$currentElement.offset(),e=tdcMaskUI.$currentElement.outerWidth(),f=tdcMaskUI.$currentElement.outerWidth(!0),d=tdcMaskUI.$currentElement.outerHeight(),l=tdcMaskUI.$currentElement.outerHeight(!0),k=tdcMaskUI.$currentElement.css("margin-top"),
m=tdcMaskUI.$currentElement.css("margin-left");12>Math.abs(a.top-c.top)?tdcMaskUI.$wrapper.addClass("tdc-mask-top"):tdcMaskUI.$wrapper.removeClass("tdc-mask-top");tdcMaskUI.$wrapper.css({top:c.top,left:c.left,width:e,height:d});tdcMaskUI.$content.css({top:c.top,left:c.left,width:e,height:d});tdcMaskUI.$contentFull.css({top:c.top-parseFloat(k),left:c.left-parseFloat(m),width:f,height:l});tdcMaskUI.$content.removeAttr("class");tdcMaskUI.$wrapper.show();tdcMaskUI.$content.show();tdcMaskUI.$contentFull.show();
...
var d=tdcOperationUI.getDraggedElement();d.insertAfter(tdcRowHandlerUI.$elementRow);tdcRowUI.bindRow(d);var l=d.prevAll(".tdc-row").length;c=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),tag:"vc_row",type:"closed",level:0,parentModel:e});new tdcIFrameData.TdcLiveView({model:c,el:d[0]});f=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:c});d.data("model_id",c.cid);tdcIFrameData.tdcRows.add(c,{at:l});d=new tdcIFrameData.TdcCollection;
...
new tdcNotice.notice("Errors happened during tdcIframeData.init() -> bindViewsModelsWrappers()!",!0,!1)}tdcDebug.log(tdcIFrameData.tdcRows.models);tdcIFrameData._isInitialized=!0}},_defineStructuredData:function(){tdcIFrameData._isInitialized||(tdcIFrameData.TdcModel=Backbone.Model.extend({getShortcodeRender:function(a,c,d,f){var h=this,l={error:e,getShortcode:""};b.isUndefined(f)?tdcIFrameData._checkModelData(h,l):tdcIFrameData._checkModelData(f,l);if(!b.isUndefined(l.getShortcode)){var k=new tdcJobManager.job;
k.shortcode=l.getShortcode;k.columns=a;k.blockUid=c;k.success_callback=function(a){tdcDebug.log(a);var n=tdcAdminIFrameUI.getIframeWindow();b.isUndefined(f)&&tdcIFrameData.deleteCallback(h);!1===d?h.set("blockUid",a.blockUid):h.set("blockUid",e);b.has(a,"replyHtml")&&(h.set("bindNewContent",d),h.set("shortcode",k.shortcode),h.set("html",a.replyHtml));b.has(a,"replyJsForEval")&&(n.tdcEvalGlobal={oldBlockUid:c},tdcAdminIFrameUI.evalInIframe(a.replyJsForEval))};k.error_callback=function(a,c){tdcDebug.log(c);
tdcDebug.log(a)};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(k)}l={error:e,getShortcode:""};tdcIFrameData._checkModelData(h,l);b.isUndefined(l.error)||tdcDebug.log(l.error);l={error:e,getShortcode:""};b.isUndefined(h.get("parentModel"))||(tdcIFrameData._checkModelData(h.get("parentModel"),l),b.isUndefined(l.error)||tdcDebug.log(l.error))}}),tdcIFrameData.TdcCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcLiveView=
...
c,b){"tdc-rows"===this.$el.attr("id")?this.$el.html(""):this.remove()},customRender:function(a,c,d){tdcDebug.log("customRender - Rendering our model");if(this.model.has("html")&&!b.isUndefined(this.model.get("html"))&&(this.$el.removeClass("tdc-dropped"),this.$el.removeClass("tdc-changed"),this.$el.html(this.model.get("html")),setTimeout(function(){"undefined"!==typeof tdcIFrameData.iframeContents.lastMouseEvent&&tdcMaskUI.repositionMask(tdcIFrameData.iframeContents.lastMouseEvent)},100),d=this.$el.find(".td_block_wrap"),
d.length&&0===parseInt(d.height())&&d.addClass("tdc-block-empty"),this.model.has("bindNewContent")&&!0===this.model.get("bindNewContent")))if(this.model.set("bindNewContent",!1,{silent:!0}),this.$el.hasClass("tdc-element-inner-row-temp")){var f=this.$el.find(".tdc-inner-row");c=a.get("childCollection");this.$el.removeClass("tdc-element-inner-row-temp").addClass("tdc-element-inner-row");this.model.set("blockUid",f.attr("id"));window.addInnerRowWrappers(this.$el);if(!b.isUndefined(c)){var h={};tdcIFrameData.bindViewsModelsWrappers(h,
c,this.$el,3);if(!b.isEmpty(h)){for(var l in h)tdcDebug.log(h[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}}tdcInnerRowUI.init(this.$el.parent());tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el)},e,this.model)}else if(this.$el.hasClass("tdc-element-inner-row")){f=
this.$el.find(".tdc-inner-row");c=this.model.get("childCollection");b.isUndefined(c)||c.reset();window.addInnerRowWrappers(this.$el);this.model.set("blockUid",f.attr("id"));var k=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,k,a)&&(c=this.model.get("childCollection"),!b.isUndefined(c)&&(h={},tdcIFrameData.bindViewsModelsWrappers(h,c,this.$el,3),!b.isEmpty(h)))){for(l in h)tdcDebug.log(h[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
...
a=tdcShortcodeParser.parse(0,window.atob(a));if(a.length!==l.length)new tdcNotice.notice("Errors happened in templateContent(content.length!==$tdcRows.length) during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);else{var p=tdcIFrameData.tdcRows;tdcIFrameData.tdcRows=new tdcIFrameData.TdcCollection;b.each(a,function(a,c,b){tdcIFrameData._getData(e,a,h)});b.isEmpty(h)||(tdcDebug.log(h),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",!0,
!1));a={error:e,shortcode:e};tdcIFrameData.checkCurrentData(a);b.isUndefined(a.error)||(tdcDebug.log(a.error),new tdcNotice.notice(h,!0,!1));l.length!==tdcIFrameData.tdcRows.length?new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",!0,!1):(m.$el.find(".tdc-row").each(function(a,c){var e=g(c);e.insertBefore(m.$el);var d=tdcIFrameData.tdcRows.at(a);new tdcIFrameData.TdcLiveView({model:d,el:c});var f=m.$el.prevAll().length,h=d.get("childCollection");
p.add(d,{at:f});window.addRowWrappers(e);if(!0===tdcIFrameData._initNewContentStructureData(1,k,d)&&!b.isUndefined(h))if(f={},tdcIFrameData.bindViewsModelsWrappers(f,h,e,1),b.isEmpty(f))e.data("model_id",d.cid);else{for(var l in f)tdcDebug.log(f[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1)}}),tdcIFrameData.tdcRows.reset(),tdcIFrameData.tdcRows=p,m.$el.remove(),tdcIFrameData.removeModel(m.model),tdcRowUI.init(f),tdcColumnUI.init(f),tdcInnerRowUI.init(f),
tdcInnerColumnUI.init(f),tdcElementUI.init(f),tdcSidebar.setSettings({$currentRow:f},e,this.model))}}else if(f=this.$el.find(".tdc-row"),c=a.get("childCollection"),this.$el.removeClass("tdc-row-temp").addClass(f.attr("class")),this.$el.attr("id",f.attr("id")),this.$el.html(f.html()),this.model.set("blockUid",f.attr("id")),window.addRowWrappers(this.$el),h={},tdcIFrameData.bindViewsModelsWrappers(h,c,this.$el,1),b.isEmpty(h))tdcRowUI.init(this.$el.parent()),tdcColumnUI.init(this.$el),tdcElementUI.init(this.$el),
tdcSidebar.setSettings({$currentRow:this.$el,$currentColumn:tdcOperationUI.inColumn(d),$currentElement:d},e,this.model);else{for(l in h)tdcDebug.log(h[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1)}else if(this.$el.hasClass("tdc-row")){f=this.$el.find(".tdc-row");c=this.model.get("childCollection");b.isUndefined(c)||c.reset();this.$el.html(f.html());this.$el.attr("class",f.attr("class"));this.$el.attr("id",f.attr("id"));this.model.set("blockUid",
f.attr("id"));window.addRowWrappers(this.$el);k=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(1,k,this.model)&&!b.isUndefined(c)&&(h={},tdcIFrameData.bindViewsModelsWrappers(h,c,this.$el,1),!b.isEmpty(h))){for(l in h)tdcDebug.log(h[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:this.$el},
e,this.model)}else if(this.$el.hasClass("tdc-column")){f=this.$el.find(".tdc-column");c=this.model.get("childCollection");b.isUndefined(c)||c.reset();f.unwrap();this.$el=f;this.$el.data("model_id",this.model.cid);window.addColumnWrappers(this.$el);k=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(2,k,this.model)&&!b.isUndefined(c)&&(h={},tdcIFrameData.bindViewsModelsWrappers(h,c,this.$el,2),!b.isEmpty(h))){for(l in h)tdcDebug.log(h[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}tdcColumnUI.init(this.$el.parent());tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:this.$el},e,this.model)}else if(this.$el.hasClass("tdc-inner-row")){f=this.$el.find(".tdc-inner-row");c=this.model.get("childCollection");b.isUndefined(c)||c.reset();this.$el.html(f.html());window.addInnerRowWrappers(this.$el);k=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,
k,this.model)&&!b.isUndefined(c)&&(h={},tdcIFrameData.bindViewsModelsWrappers(h,c,this.$el,3),!b.isEmpty(h))){for(l in h)tdcDebug.log(h[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:this.$el},e,this.model)}else if(this.$el.hasClass("tdc-inner-column")){f=
this.$el.find(".tdc-inner-column");c=this.model.get("childCollection");b.isUndefined(c)||c.reset();f.unwrap();this.$el=f;this.$el.data("model_id",this.model.cid);window.addInnerColumnWrappers(this.$el);k=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(4,k,this.model)&&!b.isUndefined(c)&&(h={},tdcIFrameData.bindViewsModelsWrappers(h,c,this.$el,4),!b.isEmpty(h))){for(l in h)tdcDebug.log(h[l]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
...
c,f,a)});b.isEmpty(f)||(tdcDebug.log(f),new tdcNotice.notice(f,!0,!1));c={error:e,shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice("Errors happened during _initNewContentStructureData() -> checkCurrentData()!",!0,!1))}return!0},_getData:function(a,c,d,f){var h;var l=b.isUndefined(a)?tdcIFrameData.tdcRows:a.get("childCollection");for(var k in tdcIFrameData._shortcodeParserSettingsClone)if(!(!b.isUndefined(f)&&parseInt(f,10)>k||b.isUndefined(c.shortcode))&&
b.isObject(c.shortcode)&&b.has(c.shortcode,"tag")&&-1!==b.indexOf(tdcIFrameData._shortcodeParserSettingsClone[k],c.shortcode.tag)){0<parseInt(k,10)&&b.isUndefined(a)&&(h="Not rows as the first elements!");!b.isUndefined(a)&&parseInt(a.get("level"),10)>=parseInt(k,10)&&(h="Elements does not respect the shortcode levels!");!b.isUndefined(a)&&1<parseInt(k,10)-parseInt(a.get("level"),10)&&2!==parseInt(a.get("level"),10)&&4!==parseInt(k,10)&&(h="Elements respect the shortcode levels, but the difference higher than 1 is not allowed here!");
b.isUndefined(h)||(d[b.keys(d).length]={element:c,info:h,parentModel:a});4!==parseInt(k,10)||b.isUndefined(c.shortcode.content)||(f=b.clone(c.shortcode.attrs.named),f.content=c.shortcode.content,c.shortcode.attrs.named=f);var m=new tdcIFrameData.TdcModel({content:c.content,attrs:c.shortcode.attrs.named,tag:c.shortcode.tag,type:c.shortcode.type,level:parseInt(k,10),parentModel:a,bindNewContent:!1});b.has(c,"child")&&0<c.child.length&&(m.set("childCollection",new tdcIFrameData.TdcCollection),b.each(c.child,
function(a,c,b){tdcIFrameData._getData(m,a,d,e)}));break}b.isUndefined(m)?d[b.keys(d).length]={element:c,info:"Element not found!",parentModel:a}:b.isUndefined(l)||l.add(m)},getModel:function(a,c){if(tdcIFrameData._isInitialized){var e;b.isUndefined(c)&&(c=tdcIFrameData.tdcRows);b.each(c.models,function(c,d,h){b.isUndefined(e)&&(c.cid===a?e=c:c.has("childCollection")&&(c=c.get("childCollection"),e=tdcIFrameData.getModel(a,c)))});if(!b.isUndefined(e))return e}},getFirstModelByTag:function(a,c){if(tdcIFrameData._isInitialized){var e;
b.isUndefined(c)&&(c=tdcIFrameData.tdcRows);b.each(c.models,function(c,d,h){b.isUndefined(e)&&(c.attributes.tag===a?e=c:c.has("childCollection")&&(c=c.get("childCollection"),e=tdcIFrameData.getFirstModelByTag(a,c)))});if(!b.isUndefined(e))return e}},removeModel:function(a,c,e){(b.isUndefined(c)||!0===c)&&tdcIFrameData.deleteCallback(a);c=a.get("parentModel");b.isUndefined(e)&&(e={});b.isUndefined(c)?tdcIFrameData.tdcRows.remove(a,e):c.get("childCollection").remove(a,e)},deleteCallback:function(a){var c=
a.get("blockUid");a=a.get("childCollection");tdcAdminIFrameUI.getIframeWindow().tdcComposerBlocksApi.deleteItem(c);!b.isUndefined(a)&&a.length&&b.each(a.models,function(a,c,b){tdcIFrameData.deleteCallback(a)})},_checkModelData:function(a,c){if(b.isUndefined(c.error)){var d=a.get("parentModel");if(0!==a.level||b.isUndefined(d))if(!b.isUndefined(d)&&parseInt(d.get("level"),10)>=parseInt(a.level,10))c.error="Elements does not respect the shortcode levels!";else if(!b.isUndefined(d)&&1<parseInt(a.level,
10)-parseInt(d.get("level"),10)&&2!==parseInt(d.get("level"),10)&&4!==parseInt(a.level,10))c.error="Elements respect the shortcode levels, but the difference higher than 1 is not allowed here!";else{!b.isUndefined(c.getShortcode)&&b.isUndefined(c.deepLevel)&&(c.deepLevel=0,c["tempShortcodeDeepLevel"+c.deepLevel]="");if(!b.isUndefined(c.getShortcode)&&a.has("templateContent")&&""!==a.get("templateContent"))c.template=window.atob(a.get("templateContent"));else if(a.has("childCollection")){b.isUndefined(c.getShortcode)||
(c.deepLevel++,c["tempShortcodeDeepLevel"+c.deepLevel]="");var f=a.get("childCollection");b.each(f.models,function(a,b,e){tdcIFrameData._checkModelData(f.get(a.cid),c)});b.isUndefined(c.getShortcode)||c.deepLevel--}if(!b.isUndefined(c.getShortcode)){d=a.get("type");var n=a.get("tag"),l=a.get("attrs"),k="";if("undefined"!==typeof c.images){var m=b.clone(l);b.map(l,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[n].params,function(a,d){if(e===a.param_name)if("attach_image"===a.type){var f=
l[a.param_name],h=tdcJobManager._getUniqueID();b.isUndefined(c.images.ids)?(c.images.ids={},c.images.ids[f]=h):b.isUndefined(c.images.ids[f])?c.images.ids[f]=h:h=c.images.ids[f];m[e]=h}else if("tdc_css"===a.param_name&&""!==l.tdc_css){var n=JSON.parse(window.atob(l.tdc_css));b.map(n,function(a,e){b.map(n[e],function(a,d){if(0===a.trim().indexOf("url")){var f=tdcJobManager._getUniqueID();b.isUndefined(c.images.urls)?(c.images.urls={},c.images.urls[a]=f):b.isUndefined(c.images.urls[a])?c.images.urls[a]=
f:f=c.images.urls[a];n[e][d]=f}})});m.tdc_css=window.btoa(JSON.stringify(n))}})});l=m}else"undefined"!==typeof c.newImages&&(m=b.clone(l),b.map(l,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[n].params,function(a,d){if(e===a.param_name)if("attach_image"===a.type){var f=l[a.param_name],h=c.newImages.find(function(a){return f===a.uid.substring(8)});"undefined"!==typeof h&&(m[e]=h.attachment_id)}else if("tdc_css"===a.param_name&&""!==l.tdc_css){var n=JSON.parse(window.atob(l.tdc_css));
b.map(n,function(a,e){b.map(n[e],function(a,b){var d=c.newImages.find(function(c){return a===c.uid.substring(8)});"undefined"!==typeof d&&(n[e][b]='url("'+d.url+'")')})});m.tdc_css=window.btoa(JSON.stringify(n))}})}),l=m,a.set("attrs",l));if("td_block_text_with_title"===n||"vc_column_text"===n||"vc_raw_html"===n)b.map(l,function(a,c){"content"!==c&&(k+=" "+c+'="'+a+'"')}),k=b.has(l,"content")?"["+n+k+"]"+b.unescape(l.content)+"[/"+n+"]":"["+n+k+"]";else switch(b.map(l,function(a,c){k+=" "+c+'="'+
a+'"'}),d){case "single":k="["+n+k+"]";break;case "closed":d="";b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)])||(d=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)]=e);k="["+n+k+"]"+d+"[/"+n+"]";break;case "template":k=c.template}c["tempShortcodeDeepLevel"+c.deepLevel]+=k;0===c.deepLevel&&(c.getShortcode+=k)}}else c.error="Not rows as the first elements!"}},checkCurrentData:function(a){tdcIFrameData._isInitialized&&b.each(tdcIFrameData.tdcRows.models,
function(c,b,e){tdcIFrameData._checkModelData(tdcIFrameData.tdcRows.get(c.cid),a)})},changeData:function(a){if(tdcIFrameData._isInitialized){tdcMain.setContentModified();var c=tdcOperationUI.getDraggedElement(),d=c.prevAll().length;if(a.wasSidebarElementDragged)if(a.wasElementDragged){var f=tdcIFrameData._getDestinationModel([".tdc-inner-column",".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);var n=tdcIFrameData._getDestinationCol();
f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection);var l=f.get("childCollection");var k={},m=c.data("start-values"),g;"undefined"!==typeof m&&(m=JSON.parse(window.atob(m)),"undefined"!==typeof m&&(b.isArray(m)&&m.length?(k=m[0],1<m.length&&(g=m)):k=m));m=c.data("shortcodeName");m=new tdcIFrameData.TdcModel({content:"",attrs:k,tag:m,type:"single",level:4,parentModel:f});new tdcIFrameData.TdcLiveView({model:m,el:c[0]});b.isUndefined(g)||m.set("presetValues",g);tdcElementUI.bindElement(c);
tdcRecycle.takeSnapshot(m.get("tag")+" : sidebar element added");c.data("model_id",m.cid);l.add(m,{at:d});m.set("parentModel",f);m.getShortcodeRender(n,a.draggedBlockUid,!0)}else a.wasTempInnerRowDragged?(tdcRecycle.takeSnapshot("Sidebar inner-row added"),f=tdcIFrameData._getDestinationModel([".tdc-column"]),b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1),n=tdcIFrameData._getDestinationCol(),f.has("childCollection")||f.set("childCollection",
new tdcIFrameData.TdcCollection),l=f.get("childCollection"),m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:2,parentModel:f}),new tdcIFrameData.TdcLiveView({model:m,el:c[0]}),k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:m}),c.data("model_id",m.cid),l.add(m,{at:d}),c=new tdcIFrameData.TdcCollection,c.add(k),m.set("childCollection",c),c=new tdcIFrameData.TdcCollection,k.set("childCollection",c),m.getShortcodeRender(n,
a.draggedBlockUid,!0)):a.wasTempRowDragged&&(tdcRecycle.takeSnapshot("Sidebar row added"),m=c.data("templateContent"),b.isUndefined(m)?(n=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:n,el:c[0]}),k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:n}),c.data("model_id",n.cid),tdcIFrameData.tdcRows.add(n,{at:d}),d=new tdcIFrameData.TdcCollection,d.add(k),n.set("childCollection",
d),d=new tdcIFrameData.TdcCollection,k.set("childCollection",d),a.wasElementWithRowDragged&&(l={},f={},m=c.data("start-values"),g=c.data("row-start-values"),"undefined"!==typeof g&&(f=JSON.parse(window.atob(g))),n.set({attrs:f}),"undefined"!==typeof m&&(l=JSON.parse(window.atob(m)),b.isArray(l)&&(l=l[0])),m=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",attrs:l,tag:m,type:"single",level:2,parentModel:k}),d.add(c),d=new tdcIFrameData.TdcCollection,c.set("childCollection",d))):(n=
new tdcIFrameData.TdcModel({templateContent:m,attrs:{},tag:"vc_row",type:"template",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:n,el:c[0]}),c.data("model_id",n.cid),tdcIFrameData.tdcRows.add(n,{at:d}),d=new tdcIFrameData.TdcCollection,n.set("childCollection",d)),n.getShortcodeRender(1,a.draggedBlockUid,!0));else{m=c.data("model_id");if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model id is not in $draggedElement data!",!0,!1);return}m=tdcIFrameData.getModel(m);
if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model not in structure data!",!0,!1);return}if(a.wasElementDragged){tdcDebug.log("case 1");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("element recycled");tdcIFrameData.removeModel(m);return}tdcRecycle.takeSnapshot(m.get("tag")+" : element moved");g=m.get("parentModel");f=tdcIFrameData._getDestinationModel([".tdc-inner-column",".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1);g.cid===f.cid?(n=g.get("childCollection"),n.remove(m,{silent:!0}),n.add(m,{at:d})):(n=tdcIFrameData._getDestinationCol(),f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection),l=f.get("childCollection"),tdcIFrameData.removeModel(m,!1,{silent:!0}),l.add(m,{at:d}),m.set("parentModel",f),a.sourceColParam!==n&&m.getShortcodeRender(n,a.draggedBlockUid,!0))}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");
tdcRecycle.takeSnapshot("Inner row recycled");tdcIFrameData.removeModel(m);return}tdcRecycle.takeSnapshot("Inner row moved");g=m.get("parentModel");f=tdcIFrameData._getDestinationModel([".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(g.cid===f.cid)n=g.get("childCollection"),n.remove(m,{silent:!0}),n.add(m,{at:d});else{f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection);l=f.get("childCollection");
tdcIFrameData.removeModel(m,!0,{silent:!0});l.add(m,{at:d});m.set("parentModel",f);a=g.get("attrs");d=f.get("attrs");if(b.has(a,"width"))switch(a.width){case "1/3":n="13";break;case "2/3":n="23"}if(b.has(d,"width"))switch(d.width){case "1/3":k="13";break;case "2/3":k="23"}b.isUndefined(n)&&(n="11");b.isUndefined(k)&&(k="11");if(n!==k&&(a=m.get("childCollection"),!b.isUndefined(a))){a=tdcIFrameData.getChildCollectionWidths(a);b.isUndefined(a)&&(a="11");d="11";l=1;switch(k){case "11":switch(a){case "11":d=
"11";break;case "23_13":d="23_13";break;case "13_23":d="13_23";break;case "12_12":d="13_13_13";break;case "13_13_13":d="13_13_13"}l=3;break;case "13":switch(a){case "11":d="11";break;case "23_13":d="11";break;case "13_23":d="11";break;case "12_12":d="11";break;case "13_13_13":d="11"}break;case "23":switch(a){case "11":d="12_12";break;case "23_13":d="12_12";break;case "13_23":d="12_12";break;case "12_12":d="12_12";break;case "13_13_13":d="12_12"}l=2}if(a!==d||n!==k)tdcIFrameData.changeInnerRowModel(m,
a,d),m.getShortcodeRender(l,null,!0)}a=tdcOperationUI.inRow(c);d=tdcOperationUI.inColumn(c);c=tdcOperationUI.inInnerRow(c);b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(c)||tdcSidebar.setSettings({$currentRow:a,$currentColumn:d,$currentInnerRow:c},!0)}}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),a.wasColumnDragged?tdcRecycle.takeSnapshot("Column moved"):a.wasInnerColumnDragged&&tdcRecycle.takeSnapshot("Inner-column moved"),g=m.get("parentModel"),n=g.get("childCollection"),
n.remove(m,{silent:!0}),n.add(m,{at:d}),a.wasColumnDragged?(a=tdcOperationUI.inRow(c),b.isUndefined(a)||tdcSidebar.setSettings({$currentRow:a})):a.wasInnerColumnDragged&&(a=tdcOperationUI.inRow(c),d=tdcOperationUI.inColumn(c),c=tdcOperationUI.inInnerRow(c),b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(c)||tdcSidebar.setSettings({$currentRow:a,$currentColumn:d,$currentInnerRow:c}));else if(a.wasRowDragged){tdcDebug.log("case 4");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("row recycled");
tdcRecycle.takeSnapshot("Row recycled");tdcIFrameData.removeModel(m);tdcDebug.log(tdcIFrameData.tdcRows);tdcIFrameData.tdcRows.length||(n=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:n,el:tdcIFrameData.iframeContents.find("#tdc-rows")[0]}),k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:n}),tdcIFrameData.tdcRows.add(n,{at:0}),d=new tdcIFrameData.TdcCollection,
d.add(k),n.set("childCollection",d),d=new tdcIFrameData.TdcCollection,k.set("childCollection",d),n.getShortcodeRender(1,a.draggedBlockUid,!0));return}tdcRecycle.takeSnapshot("Row moved");tdcIFrameData.tdcRows.remove(m,{silent:!0});tdcIFrameData.tdcRows.add(m,{at:d});tdcDebug.log("newPosition: "+d);tdcDebug.log(c)}}tdcDebug.log(tdcIFrameData.tdcRows)}},_parseModelWidthAttrs:function(a){a=a.get("attrs");var c=3;if(b.has(a,"width"))switch(a.width){case "1/3":c=1;break;case "2/3":c=2;break;case "1/2":c=
1}return c},getColumnNumber:function(a){var c=3,e=parseInt(a.get("level"),10),d=a.get("parentModel");b.isUndefined(d)||(4===e?(a=tdcIFrameData._parseModelWidthAttrs(d),c=3===a?tdcIFrameData.getColumnNumber(d):a):(a=tdcIFrameData._parseModelWidthAttrs(a),c=3===a?tdcIFrameData.getColumnNumber(d):a));return c},_getDestinationModel:function(a){for(var c=tdcOperationUI.getDraggedElement(),e,d=0;d<a.length&&(e=c.closest(a[d]),!e.length);d++);e.length||new tdcNotice.notice("_getDestinationModel Error: Container destination not available!",
!0,!1);a=e.data("model_id");b.isUndefined(a)&&new tdcNotice.notice("_getDestinationModel Error: Model id of the container destination not in data!",!0,!1);a=tdcIFrameData.getModel(a);b.isUndefined(a)&&new tdcNotice.notice("_getDestinationModel Error: Model not in structure data!",!0,!1);return a},_getDestinationCol:function(){var a=tdcOperationUI.getDraggedElement();var c=a.closest(".tdc-column");a=a.closest(".tdc-inner-column");if(a.length&&(a=a.data("model_id"),b.isUndefined(a)&&new tdcNotice.notice("_getDestinationCol Error: The inner column model id not in data!",
...
"";b.each(tdcIFrameData.tdcRows.models,function(c,b,e){tdcIFrameData._checkModelData(tdcIFrameData.tdcRows.get(c.cid),a)})},bindViewsModelsWrappers:function(a,c,e,d){if(b.isEmpty(a)){b.isUndefined(d)&&(d=0);if(b.isUndefined(c)){c=tdcIFrameData.tdcRows;e=tdcIFrameData.iframeContents.find("#tdc-rows .tdc-row");if(c.models.length!==e.length){a[b.keys(a).length]={collection:c,jqDOMElements:e,info:"Error at rows: "+c.models.length+"(models) : "+e.length+"(dom)"};return}d++;b.each(e,function(b,e,f){e=c.models[e];
f=g(b);f.data("model_id",e.cid);e.set("blockUid",f.attr("id"));e.set("html",b.innerHTML);new tdcIFrameData.TdcLiveView({model:e,el:b});e.has("childCollection")&&tdcIFrameData.bindViewsModelsWrappers(a,e.get("childCollection"),f,d)})}else{switch(d){case 1:var f=e.find(".tdc-columns:first").children(".tdc-column");if(c.models.length!==f.length){a[b.keys(a).length]={collection:c,jqDOMElements:f,info:"Errors at columns: "+c.models.length+"(models) : "+f.length+"(dom)",level:d};return}break;case 2:f=e.find(".tdc-elements:first").children(".tdc-element, .tdc-element-inner-row");
if(c.models.length!==f.length){a[b.keys(a).length]={collection:c,jqDOMElements:f,info:"Errors at columns elements: "+c.models.length+"(models) : "+f.length+"(dom)",level:d};return}break;case 3:f=e.find(".tdc-inner-columns:first").children(".tdc-inner-column");if(c.models.length!==f.length){a[b.keys(a).length]={collection:c,jqDOMElements:f,info:"Errors at inner columns: "+c.models.length+"(models) : "+f.length+"(dom)",level:d};return}break;case 4:if(f=e.find(".tdc-elements:first").children(".tdc-element"),
c.models.length!==f.length){a[b.keys(a).length]={collection:c,jqDOMElements:f,info:"Errors at elements: "+c.models.length+"(models) : "+f.length+"(dom)",level:d};return}}d++;b.each(f,function(e,f,h){f=c.models[f];h=g(e);h.data("model_id",f.cid);f.set("html",e.innerHTML,{silent:!0});var l;if(4===f.get("level")){var n=h.find(".td_block_inner");n.length&&(l=n.attr("id"))}else 2===f.get("level")&&(n=h.find(".tdc-inner-row"),n.length&&(l=n.attr("id")));f.set("blockUid",l);new tdcIFrameData.TdcLiveView({model:f,
el:e});!h.hasClass("tdc-element")&&f.has("childCollection")&&0<b.size(f.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,f.get("childCollection"),h,d)})}d--}},changeRowModel:function(a,c,e){var d=a.get("childCollection");if("11"===c&&("23_13"===e||"13_23"===e||"13_13_13"===e)){e=e.split("_");var h=e[0].charAt(0)+"/"+e[0].charAt(1),l=d.at(0),k=l.get("attrs");b.isUndefined(k)?l.set("attrs",{width:h}):(k=b.clone(k),k.width=h,l.set("attrs",k));d.add(new tdcIFrameData.TdcModel({content:"",
tag:"vc_column",attrs:{width:e[1].charAt(0)+"/"+e[1].charAt(1)},type:"closed",level:1,parentModel:a}));3===e.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a}));tdcIFrameData.changeColumnModel(l,c,e[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===e){c=c.split("_");l=d.at(0);k=l.get("attrs");var m=l.get("childCollection"),g=d.at(1),q=g.get("childCollection");b.isUndefined(k)||(k=b.clone(k),
delete k.width,l.set("attrs",k));b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,l.set("childCollection",m));!b.isUndefined(q)&&q.length&&b.each(q.models,function(a,c,b){a.set("parentModel",l);m.add(a)});3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",l);m.add(a)}),tdcIFrameData.removeModel(a));tdcIFrameData.removeModel(g);tdcIFrameData.changeColumnModel(l,c[0],e)}else if(!("23_13"!==c&&"13_23"!==c&&"13_13_13"!==
c||"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)){c=c.split("_");e=e.split("_");h=e[0].charAt(0)+"/"+e[0].charAt(1);var r=e[1].charAt(0)+"/"+e[1].charAt(1);l=d.at(0);k=l.get("attrs");g=d.at(1);var w=g.get("attrs");q=g.get("childCollection");3===e.length?d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&(b.isUndefined(q)&&(q=
new tdcIFrameData.TdcCollection,g.set("childCollection",q)),b.each(d.models,function(a,c,b){a.set("parentModel",g);q.add(a)})),tdcIFrameData.removeModel(a));k=b.clone(k);k.width=h;l.set("attrs",k);c[0]!==e[0]&&tdcIFrameData.changeColumnModel(l,c[0],e[0]);h=b.clone(w);h.width=r;g.set("attrs",h);c[1]!==e[1]&&tdcIFrameData.changeColumnModel(g,c[1],e[1])}tdcDebug.log(tdcIFrameData.tdcRows.models)},changeFluidStructureModel:function(a,c,e){var d=a.get("childCollection"),h=a.get("tag"),l="vc_column";c=
c.split("_");var k=e.split("_");if("vc_row"===h||"vc_row_inner"===h){"vc_row_inner"===h&&(l="vc_column_inner");if(k.length>c.length)for(h=0;h<k.length;h++){e="";for(var m=0;m<k[h].length;m++)e+=k[h].charAt(m)+"/";""!==e&&(e=e.substring(0,e.length-1));if(h<c.length){var g=d.at(h);m=g.get("attrs");var q=b.clone(m);q.width=e;g.set("attrs",q)}else d.add(new tdcIFrameData.TdcModel({content:"",tag:l,attrs:{width:e},type:"closed",level:1,parentModel:a}))}else for(h=0;h<c.length;h++)if(h<k.length){g=d.at(h);
m=g.get("attrs");q=b.clone(m);e="";for(m=0;m<k[h].length;m++)e+=k[h].charAt(m)+"/";""!==e&&(e=e.substring(0,e.length-1));q.width=e;g.set("attrs",q);var r=g}else{g=d.at(k.length);a=g.get("childCollection");var w=r.get("childCollection");b.isUndefined(w)&&(w=new tdcIFrameData.TdcCollection,r.set("childCollection",w));b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",r);w.add(a)});tdcIFrameData.removeModel(g)}tdcDebug.log(tdcIFrameData.tdcRows.models)}},changeColumnModel:function(a,
c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if(!b.isUndefined(d)&&d.length){var h=a.get("attrs");!b.isUndefined(h)&&b.has(h,"width");b.each(d.models,function(d,f,h){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var n="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(n=c===e.length-1?n+a.width:n+(a.width+"_"))});n=n.replace(/\//g,"");"12_12"!==n&&
"23_13"!==n&&"13_23"!==n&&"13_13_13"!==n&&(n="");if("11"===c)if("23"===e)if("23_13"===n){var l=d.at(0),k=d.at(1);h=l.get("attrs");f=k.get("attrs");h=b.clone(h);f=b.clone(f);h.width="1/2";f.width="1/2";l.set("attrs",h);k.set("attrs",f)}else if("13_23"===n)l=d.at(0),k=d.at(1),h=l.get("attrs"),f=k.get("attrs"),h=b.clone(h),f=b.clone(f),h.width="1/2",f.width="1/2",l.set("attrs",h),k.set("attrs",f);else if("13_13_13"===n){l=d.at(0);k=d.at(1);d=d.at(2);h=l.get("attrs");f=k.get("attrs");var g=d.get("attrs");
h=b.clone(h);f=b.clone(f);b.clone(g);h.width="1/2";f.width="1/2";l.set("attrs",h);k.set("attrs",f);f=d.get("childCollection");if(!b.isUndefined(f)&&f.length){var m=k.get("childCollection");b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,k.set("childCollection",m));b.each(f.models,function(a,c,b){m.add(a);a.set("parentModel",k)})}tdcIFrameData.removeModel(d)}else{if(d.models.length){l=d.at(0);h=l.get("attrs");h=b.clone(h);var t=l.get("childCollection");delete h.width;l.set("attrs",h);b.isUndefined(t)&&
(t=new tdcIFrameData.TdcCollection,l.set("childCollection",t));var v=0;for(b.each(d.models,function(a,c,e){0!==c&&(v=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);t.add(a)}))});0<v;)tdcIFrameData.removeModel(d.at(v)),v--}}else{if("13"===e&&d.models.length)for(l=d.at(0),h=l.get("attrs"),h=b.clone(h),t=l.get("childCollection"),delete h.width,l.set("attrs",h),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,l.set("childCollection",t)),v=0,b.each(d.models,
function(a,c,e){0!==c&&(v=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);t.add(a)}))});0<v;)tdcIFrameData.removeModel(d.at(v)),v--}else if("23"===c)if("11"===e)if("12_12"===n)l=d.at(0),k=d.at(1),h=l.get("attrs"),f=k.get("attrs"),h=b.clone(h),f=b.clone(f),h.width="1/3",f.width="1/3",l.set("attrs",h),k.set("attrs",f),f=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(f);
else{if(d.models.length)for(l=d.at(0),h=l.get("attrs"),h=b.clone(h),t=l.get("childCollection"),delete h.width,l.set("attrs",h),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,l.set("childCollection",t)),v=0,b.each(d.models,function(a,c,e){0!==c&&(v=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a){a.set("parentModel",l);t.add(a)}))});0<v;)tdcIFrameData.removeModel(d.at(v)),v--}else{if("13"===e&&d.models.length)for(l=d.at(0),h=l.get("attrs"),h=b.clone(h),t=l.get("childCollection"),
delete h.width,l.set("attrs",h),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,l.set("childCollection",t)),v=0,b.each(d.models,function(a,c,e){0!==c&&(v=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);t.add(a)}))});0<v;)tdcIFrameData.removeModel(d.at(v)),v--}else if("13"===c)if("11"===e)if(""===n||"12_12"!==n&&"23_13"!==n&&"13_23"!==n&&"13_13_13"!==n){if(d.models.length)for(l=d.at(0),h=l.get("attrs"),h=b.clone(h),t=l.get("childCollection"),
delete h.width,l.set("attrs",h),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,l.set("childCollection",t)),v=0,b.each(d.models,function(a,c,e){0!==c&&(v=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);t.add(a)}))});0<v;)tdcIFrameData.removeModel(d.at(v)),v--}else"12_12"===n&&d.models.length&&(l=d.at(0),k=d.at(1),h=l.get("attrs"),f=k.get("attrs"),h.width="1/3",f.width="1/3",l.set("attrs",h),k.set("attrs",f),d.add(new tdcIFrameData.TdcModel({content:"",
tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===n||"12_12"!==n)&&d.models.length)for(l=d.at(0),h=l.get("attrs"),h=b.clone(h),t=l.get("childCollection"),delete h.width,l.set("attrs",h),b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,l.set("childCollection",t)),v=0,b.each(d.models,function(a,c,e){0!==c&&(v=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);t.add(a)}))});0<v;)tdcIFrameData.removeModel(d.at(v)),
v--}})}}},changeInnerRowModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if("11"!==c||"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)"13_13_13"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e?tdcIFrameData.changeFluidStructureModel(a,c,e):("11"===e?(q=d.at(0),r=q.get("attrs"),h=q.get("childCollection"),k=d.at(1),l=k.get("childCollection"),
a=d.at(2),d=a.get("childCollection"),b.isUndefined(r)||(r=b.clone(r),delete r.width,q.set("attrs",r)),b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",h)),!b.isUndefined(l)&&l.length&&b.each(l.models,function(a,c,b){a.set("parentModel",q);h.add(a)}),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",q);h.add(a)}),tdcIFrameData.removeModel(k)):(g=e.split("_"),p=g[0].charAt(0)+"/"+g[0].charAt(1),c=g[1].charAt(0)+"/"+g[1].charAt(1),q=d.at(0),
r=q.get("attrs"),k=d.at(1),e=k.get("attrs"),l=k.get("childCollection"),a=d.at(2),d=a.get("childCollection"),r=b.clone(r),r.width=p,q.set("attrs",r),e=b.clone(e),e.width=c,k.set("attrs",e),b.isUndefined(l)&&(l=new tdcIFrameData.TdcCollection,k.set("childCollection",l)),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",k);l.add(a)})),tdcIFrameData.removeModel(a));else if("11"===e){q=d.at(0);r=q.get("attrs");var h=q.get("childCollection");k=d.at(1);var l=k.get("childCollection");
b.isUndefined(r)||(r=b.clone(r),delete r.width,q.set("attrs",r));b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",h));!b.isUndefined(l)&&l.length&&b.each(l.models,function(a,c,b){a.set("parentModel",q);h.add(a)});tdcIFrameData.removeModel(k)}else g=e.split("_"),p=g[0].charAt(0)+"/"+g[0].charAt(1),c=g[1].charAt(0)+"/"+g[1].charAt(1),q=d.at(0),r=q.get("attrs"),k=d.at(1),e=k.get("attrs"),r=b.clone(r),r.width=p,q.set("attrs",r),e=b.clone(e),e.width=c,k.set("attrs",e),3===g.length&&
d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:g[2].charAt(0)+"/"+g[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var k=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",type:"closed",level:3,parentModel:a}),g=e.split("_"),p=g[0].charAt(0)+"/"+g[0].charAt(1);c=g[1].charAt(0)+"/"+g[1].charAt(1);var q=d.at(0),r=q.get("attrs");b.isUndefined(r)?q.set("attrs",{width:p}):(r=b.clone(r),r.width=p,q.set("attrs",r));k.set("attrs",{width:c});d.add(k);3===
g.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:g[2].charAt(0)+"/"+g[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;b.map(a.models,function(a,e){var d=a.get("attrs");b.has(d,"width")&&(c=b.isUndefined(c)?d.width.replace("/",""):c+("_"+d.width.replace("/","")))});return c}}}})(jQuery,Backbone,_);var tdcAdminIFrameUI;
...
tdcSidebarController.onUpdate(a,c,this.oldValue,e)}});d.on("keyup focus paste cut",".tdc-tab-no-design .tdc-property-textfield input",function(b){var e=setTimeout(function(a){clearTimeout(e);if("focusin"===b.type)a.oldValue=a.value;else{var c=jQuery(a).val(),d=tdcIFrameData.getModel(jQuery(a).data("model_id"));"cut"===b.type&&(c="");tdcSidebarController.onUpdate(d,jQuery(a).data("param_name"),a.oldValue,_.escape(c));a.oldValue=c}},100,this,b)});d.on("keyup focus paste cut",".tdc-tab-no-design .tdc-property-textfield-responsive input",
function(b){var e=setTimeout(function(a){clearTimeout(e);if("focusin"===b.type)a.oldValue=a.value;else{var c=jQuery(a),d=c.val(),f=tdcIFrameData.getModel(c.data("model_id"));"cut"===b.type&&(d="");if(a.oldValue!==d){var n=c.attr("name"),l=c.closest(".tdc-property-responsive");n=tdcSidebarPanel.updateTextfieldResponsiveValues(n,d,tdcSidebar.currentViewportSettings.name);var k="";_.isUndefined(c.data("placeholder"))||(k=c.data("placeholder"));c.attr("placeholder",k);l.removeClass("tdc-css-inherited");
""===d&&"all"!==tdcSidebar.currentViewportSettings.name&&(d=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),tdcSidebar.currentViewportSettings.name),"undefined"===typeof d?(d=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),"undefined"!==typeof d&&(c.val(""),c.attr("placeholder",d),l.addClass("tdc-css-inherited"),l.find(".tdc-inherit-select").show())):(c.val(d),l.removeClass("tdc-css-inherited"),l.find(".tdc-inherit-select").show()),l.find(".tdc-inherit-select").show());d=
n;tdcSidebarController.onUpdate(f,jQuery(a).data("param_name"),a.oldValue,_.escape(d));"all"===tdcSidebar.currentViewportSettings.name&&(a.oldValue=c.val())}}},100,this,b)});d.on("keyup focus change input",".tdc-tab-no-design .tdc-property-range input",function(b){var e=jQuery(this),a=this;if("range"===e.attr("type"))e.next('input[type="text"]').val(e.val());else if("text"===e.attr("type")){a=e.val().trim();var c=e.data("default_value");""!==a||_.isUndefined(c)||""===c||(a=c,e.val(a));e.prev('input[type="range"]').val(a);
e=e.prev('input[type="range"]');a=e.get(0)}var d=setTimeout(function(a){clearTimeout(d);if("focusin"===b.type)a.oldValue=a.value;else{var c=jQuery(a).val(),e=tdcIFrameData.getModel(jQuery(a).data("model_id"));"cut"===b.type&&(c="");tdcSidebarController.onUpdate(e,jQuery(a).data("param_name"),a.oldValue,_.escape(c));a.oldValue=c}},100,a,b)});d.on("keyup change input",".tdc-tab-no-design .tdc-property-range-responsive input",function(b){var e=jQuery(this),a=this,c=e.closest(".tdc-property-responsive");
c.removeClass("tdc-css-inherited");if("range"===e.attr("type")){var d=e.val();e.next('input[type="text"]').val(d);e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),d,tdcSidebar.currentViewportSettings.name))}else if("text"===e.attr("type")){d=e.val().trim();a=e.prev('input[type="range"]');var f=e.data("default_value");if("all"===tdcSidebar.currentViewportSettings.name)""!==d||_.isUndefined(f)||""===f||(d=f,e.val(d));else if(""===d){var n=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),
"all");"undefined"===typeof n?_.isUndefined(f)||""===f||(d=f,e.val(d)):(e.val(""),e.attr("placeholder",n))}a.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(a.attr("name"),d,tdcSidebar.currentViewportSettings.name));"undefined"===typeof n?a.val(d):(a.val(n),c.addClass("tdc-css-inherited"));a=e.prev('input[type="range"]').get(0)}var l=setTimeout(function(a){clearTimeout(l);var c=jQuery(a),b=c.data("data-to-save");c=tdcIFrameData.getModel(c.data("model_id"));a.oldValue!==b&&(tdcSidebarController.onUpdate(c,
jQuery(a).data("param_name"),a.oldValue,_.escape(b)),a.oldValue=b)},100,a,b)});d.on("keyup focus change input",".tdc-tab-no-design .tdc-property-range_multiple input",function(b){var e=jQuery(this),a=this;if("range"===e.attr("type")){var c=e.closest(".tdc-property").find('input[type="radio"]:checked');e.closest(".tdc-property").find('input[type="text"]').val(e.val());c.data("last_value",e.val())}else if("text"===e.attr("type")){a=e.closest(".tdc-property").find('input[type="range"]');c=e.closest(".tdc-property").find('input[type="radio"]:checked');
var d=c.data("default_value"),f=e.val().trim();""!==f||_.isUndefined(d)||""===d||(f=d,e.val(f));a.val(f);c.data("last_value",f);a=a.get(0)}else if("radio"===e.attr("type")){a=e.closest(".tdc-property").find('input[type="range"]');f=e.closest(".tdc-property").find('input[type="text"]');c=e.closest(".tdc-property").find('input[type="radio"]:checked');c=e.data("last_value");d=e.data("default_value");var n=e.data("unit");e=a.data("min_"+n);var l=a.data("max_"+n);n=a.data("step_"+n);a.get(0).min=e;a.get(0).max=
l;a.get(0).step=n;""===c?(f.val(d),a.val(d)):(f.val(c),a.val(c));a=a.get(0)}var k=setTimeout(function(a){clearTimeout(k);var c="",e=jQuery(a).parent().find('input[type="radio"]:checked');e.length&&(c=jQuery(e[0]).data("unit_value"));"focusin"===b.type?a.oldValue=a.value+c:(c=a.value+c,e=tdcIFrameData.getModel(jQuery(a).data("model_id")),tdcSidebarController.onUpdate(e,jQuery(a).data("param_name"),a.oldValue,_.escape(c)),a.oldValue=c)},100,a,b)});d.on("keyup change input",".tdc-tab-no-design .tdc-property-range_multiple-responsive input",
function(b){var e=jQuery(this),a=e.closest(".tdc-property-responsive"),c=a.find('input[type="range"]'),d=a.find('input[type="radio"]:checked'),f=a.find('input[type="text"]'),n=c.get(0),l="",k="",g=d.data("default_value"),p=tdcIFrameData.getModel(c.data("model_id")),q=c.data("param_name"),r=window.tdcAdminSettings.mappedShortcodes[p.attributes.tag],w=p="";k=[];for(var u=0;u<r.params.length;u++)if(q===r.params[u].param_name){u=r.params[u].tdc_values;for(var t in u)u.hasOwnProperty(t)&&(k.push(u[t].unit),
""===p||""===w)&&(p=u[t].value,w=u[t].unit);break}d.length&&(l=d.data("unit_value"));if("range"===e.attr("type"))k=c.val(),f.val(k),d.data("last_value",k),f.val(k),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),k+l,tdcSidebar.currentViewportSettings.name)),a.removeClass("tdc-css-inherited");else if("text"===e.attr("type")){if("input"===b.type||"change"===b.type)return;a.removeClass("tdc-css-inherited");k=f.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
k||_.isUndefined(g)||""===g?(c.val(k),d.data("last_value",k),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),k+l,tdcSidebar.currentViewportSettings.name))):(c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),c.data("range_value",p),c.data("range_unit",w),c.val(p),l=a.find('input[type="radio"][data-unit_value="'+w+'"]'),r=l.data("unit"),t=c.data("min_"+r),d=c.data("max_"+r),r=c.data("step_"+r),l.prop("checked",
!0),n.min=t,n.max=d,n.step=r,n.value=p,l.data("last_value",p),f.val(p));else if(""===k)if(l=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),"undefined"===typeof l)c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),c.data("range_value",p),c.data("range_unit",w),c.val(p),l=a.find('input[type="radio"][data-unit_value="'+w+'"]'),r=l.data("unit"),t=c.data("min_"+r),d=c.data("max_"+r),r=c.data("step_"+r),l.prop("checked",
!0),n.min=t,n.max=d,n.step=r,n.value=p,l.data("last_value",p),f.val(p),a.addClass("tdc-css-inherited");else for(u=0;u<r.params.length;u++){if(q===r.params[u].param_name){k=[];f=[];w=p="";u=r.params[u].tdc_values;for(t in u)u.hasOwnProperty(t)&&k.push(u[t].unit);for(u=0;u<k.length&&!(f=l.split(k[u]),1<f.length);u++);f.length&&(p=f[0],w=k[u],c.data("range_value",p),c.data("range_unit",w),l=a.find('input[type="radio"][data-unit_value="'+w+'"]'),r=l.data("unit"),t=c.data("min_"+r),d=c.data("max_"+r),
r=c.data("step_"+r),l.prop("checked",!0),n.min=t,n.max=d,n.step=r,n.value=p,l.data("last_value",p),a.find('input[type="text"]').val(p));c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name));a.addClass("tdc-css-inherited");break}}else c.val(k),d.data("last_value",k),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),k+l,tdcSidebar.currentViewportSettings.name))}else if("radio"===e.attr("type")){if("input"===
b.type)return;q=d.data("last_value");r=d.data("unit");t=c.data("min_"+r);d=c.data("max_"+r);r=c.data("step_"+r);n.min=t;n.max=d;n.step=r;""===q?(f.val(g),c.val(g),k=g):(f.val(q),c.val(q),k=q);c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),k+l,tdcSidebar.currentViewportSettings.name));a.removeClass("tdc-css-inherited")}var v=setTimeout(function(a){clearTimeout(v);var c="",e=jQuery(a).parent().find('input[type="radio"]:checked');e.length&&(c=jQuery(e[0]).data("unit_value"));
"focusin"===b.type?a.oldValue=a.value+c:(e=jQuery(a),c=e.data("data-to-save"),e=tdcIFrameData.getModel(e.data("model_id")),a.oldValue!==c&&(tdcSidebarController.onUpdate(e,jQuery(a).data("param_name"),a.oldValue,_.escape(c)),a.oldValue=c))},100,n,b)});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var e=b.val();b.is(":checked")||(e="");var a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,
b.data("param_name"),this.oldValue,e);this.oldValue=e}});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox-responsive input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var e=b.val(),a=tdcIFrameData.getModel(b.data("model_id")),c=b.data("param_name");b.is(":checked")||(e="");var d=b.attr("name"),f=b.closest(".tdc-property-responsive");e="all"===tdcSidebar.currentViewportSettings.name&&""===e?tdcSidebarPanel.deleteResponsiveValue(d,tdcSidebar.currentViewportSettings.name):
tdcSidebarPanel.updateCheckboxResponsiveValues(d,e,tdcSidebar.currentViewportSettings.name);f.removeClass("tdc-css-inherited");f.find(".tdc-inherit-checkbox").hide();"all"!==tdcSidebar.currentViewportSettings.name&&(d=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),tdcSidebar.currentViewportSettings.name),f=b.closest(".tdc-property-responsive"),"undefined"===typeof d?(d=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all"),"undefined"!==typeof d&&(f.addClass("tdc-css-inherited"),
f.find(".tdc-inherit-checkbox").show())):(f.removeClass("tdc-css-inherited"),f.find(".tdc-inherit-checkbox").show()),f.find(".tdc-inherit-checkbox").show());tdcSidebarController.onUpdate(a,c,this.oldValue,e);this.oldValue=e}});d.on("click",".tdc-tab-no-design .tdc-image-wrap",tdcSidebarPanel.tdcImageWrapHandler);d.on("click",".tdc-tab-no-design .tdc-image-remove",tdcSidebarPanel.tdcImageRemoveHandler);d.on("click",".tdc-tab-no-design .tdc-icon-wrap",tdcSidebarPanel.tdcIconWrapHandler);d.on("click",
".tdc-tab-no-design .tdc-icon-remove",tdcSidebarPanel.tdcIconRemoveHandler);d.on("click",".tdc-tab-no-design .tdc-inherit-select",tdcSidebarPanel.tdcInheritSelectHandler);d.on("click",".tdc-tab-no-design .tdc-inherit-checkbox",tdcSidebarPanel.tdcInheritCheckboxHandler);d.on("click",".tdc-icon-selector-content > span",function(b){b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());b.find(".selected").removeClass("selected");var e=jQuery(this),a=e.data("font_class"),c=tdcIFrameData.getModel(b.data("model_id"));
e.addClass("selected");var d=b.prev(".tdc-property-wrap");d.find(".tdc-icon-wrap").html(e.html());d.find(".tdc-icon-remove").removeClass("tdc-hidden-button");tdcSidebarController.onUpdate(c,b.data("param_name"),"",a)});d.on("change","#tdc-icon-selector .tdc-icon-selector-lib",function(){var b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var e=jQuery(this).val(),a=b.find(".tdc-icon-selector-filter");b.find(".tdc-icon-selector-content").children(".tdc-font-separator").each(function(){var c=
jQuery(this),b=c.data("font_id");""===e||e===b?(c.show(),c.nextAll("span").each(function(){var c=jQuery(this),b=c.data("font_class"),e=a.val().trim();""!==e&&-1===b.indexOf(e)?c.hide():c.show()})):(c.hide(),c.nextAll("span").hide())})});d.on("click",".tdc-tab-no-design .tdc-gradient-wrap",function(b){b=jQuery("#tdc-gradient");b.length||(b=tdcSidebar.buildGradient());var e=jQuery(this),a=e.closest(".tdc-property-wrap");e=e.next("input").val();b.toggle();a.after(b);a.next().find(".wp-picker-container").find("input.wp-color-picker").tdGradientColorPicker("open_gradient",
e)});d.on("click",".tdc-colorpicker-wrap",function(b){b=jQuery("#tdc-palette");b.length||(b=tdcSidebar.buildPalette());var e=jQuery(this),a=e.closest(".tdc-property-wrap");e=e.next("input").val();b.toggle();a.after(b);a.next().find(".wp-picker-container").find("input.wp-color-picker").tdPaletteColorPicker("open_palette",e)});d.on("mousedown",function(b){var e=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),c=jQuery("#tdc-gradient"),d=jQuery("#tdc-palette"),f=jQuery("#tdc-font-list");a.length?
a.get(0).contains(b.target)||(a.hide(),e.after(a)):tdcSidebar.buildIconSelector();c.length?c.get(0).contains(b.target)||(c.hide(),e.after(c)):tdcSidebar.buildGradient();d.length?d.get(0).contains(b.target)||(d.hide(),e.after(d)):tdcSidebar.buildPalette();f.length&&!f.get(0).contains(b.target)&&(f.hide(),e.after(f))});d.on("keyup focus paste cut change","input.tdc-icon-selector-filter",function(b){b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var e=this.value.trim();b.find(".tdc-icon-selector-content").find(".tdc-font-separator:visible").each(function(){jQuery(this).nextAll("span").each(function(){var a=
...
{};"undefined"===typeof window.tdcAdminSettings.tdcSavings[e]&&(window.tdcAdminSettings.tdcSavings[e]=[]);for(var d=!1,n=0;n<window.tdcAdminSettings.tdcSavings[e].length;n++)if(window.tdcAdminSettings.tdcSavings[e][n].name===c){d=!0;break}d?b.html('Shortcode name already exists for "'+e+'" ! Choose another one'):(b.html("Saving..."),window.tdcAdminSettings.tdcSavings[e].push({name:c,shortcode:window.btoa(a.getShortcode)}),tdcUtil.updateTdcSavings(window,function(){jQuery("#TB_ajaxContent").find(".info").html("Shortcode has been saved!");
setTimeout(function(){tb_remove()},500)}))}}})});d.on("click",".tdc-sidebar-current-styles-settings",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var e={error:g,getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,e);var a=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){e="";var c={},d={};for(f in b)0===f.indexOf("tds_")&&(c[f]=b[f]);var f=window.tdcAdminSettings.mappedShortcodes[a].params;for(a=0;a<f.length;a++){var n=!1,l=f[a];
if(0===l.param_name.indexOf("tds_")){for(var k in c)if(l.param_name===k){d[k]=c[k];n=!0;break}n||(d[l.param_name]="")}}for(k in c)switch(c=k.split("-"),c.length){case 2:if(!_.has(d,k)){f=c[0];c=!1;for(var m in d)if(f===d[m]&&1===m.split("-").length){c=!0;break}if(!c){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],f)){var q=p;break}_.has(d,q)&&""===d[q]&&window.tdcAdminSettings.globalStyle[q]===f&&(c=!0)}c||delete b[k]}break;case 3:f=c[0];a=c[2];
for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],f)){q=p;break}c=!1;for(m in d)if(f===d[m]&&m===q+"-"+a){c=!0;break}c||_.has(d,q+"-"+a)&&""===d[q+"-"+a]&&window.tdcAdminSettings.globalStyle[q]===f&&(c=!0);c||delete b[k]}for(p in b)e+='"'+p+'" => "'+b[p]+'",\n';console.log(e)}});d.on("click",".tdc-sidebar-font-reset",function(b){tdConfirm.modal({caption:"Clear Font Settings",htmlInfoContent:"This will clear all values for this font group settings.",textYes:"Yes",
objectContext:this,callbackYes:function(){tb_remove();var b=jQuery(this),a=b.data("model_id"),c=tdcIFrameData.getModel(a),d=c.get("attrs");d=_.clone(d);for(var f="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),n="",l=0;l<f.length;l++){var k=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+f[l]+":first");if(k.length){var g=k.find('[data-model_id="'+a+'"]');g.length&&(g.val(""),g.data("responsive",""),k.removeClass("tdc-css-inherited"),n=k.find(".tdc-inherit"),
n.length&&n.hide(),n=g.data("placeholder"),"undefined"!==typeof n&&g.attr("placeholder",n),n=g.data("param_name"),delete d[n],g=g.attr("name"),tdcSidebarPanel.deleteResponsiveValues(g))}}c.set("attrs",d);tdcSidebarController.onUpdate(c,n,"","")}})});d.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var e=b.data("model_id");e=tdcIFrameData.getModel(e).get("attrs");var a=b.data("param_name").replace("font_settings",""),c="font_family font_size font_line_height font_style font_weight font_transform".split(" "),
d={};_.each(e,function(b,e,h){if(0===e.indexOf(a))for(h=0;h<c.length;h++)if(0<e.indexOf(c[h])){d[c[h]]=b;break}});_.isEmpty(d)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",callbackYes:function(){var a=jQuery("#TB_ajaxContent"),c=a.find(".info");a=a.find("input").val().trim();
...
beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,e,h){"success"===e&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.data("image_height",d),b.data("image_width",
f),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),e="",h=b.data("model_id"),h=tdcIFrameData.getModel(h),b.hasClass("tdc-no-image-selected")||(e=c.image_id.toString()),c=h.get("attrs"),c.image_height=d,c.image_width=f,h.set("attrs",c),tdcSidebarController.onUpdate(h,b.data("param_name"),"",e)))}).fail(function(a,c,b){})};return!1},tdcImageRemoveHandler:function(d){var b=jQuery(d.currentTarget);d=b.closest(".tdc-property-wrap").find(".tdc-image-wrap");
...
e=e.data("param_name"),tdcSidebarController.onUpdate(a,e,"",b));d.hide()},bindPanelToModel:function(d,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==d.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){var e=window.tdcAdminSettings.mappedShortcodes[d.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=d;for(var a=[],c=0;c<e.params.length;c++){var h=tdcSidebarPanel._defaultGroupName;
_.isEmpty(e.params[c].group)||(h=e.params[c].group);a.push(h)}a=_.uniq(a);var f=h="",n=tdcSidebar.getCurrentTabId(),l,k;h+='<div class="tdc-tabs">';var g=k=l="";for(c=0;c<a.length;c++){f=tdcSidebarPanel._fixGroupName(a[c]);var p=tdcUtil.makeSafeForCSS(f);0===c?(l='<a href="#" data-tab-id="td-tab-'+p+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>",k='<a href="#" data-tab-id="td-tab-'+p+'" title="'+f+' settings">'+f+"</a>"):_.isUndefined(n)||n!=="td-tab-"+p?g+='<a href="#" data-tab-id="td-tab-'+
p+'" title="'+f+' settings">'+f+"</a>":(l=k,g+='<a href="#" data-tab-id="td-tab-'+p+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>")}f=p=k=c="";switch(tdcSidebar.currentViewportSettings.name){case "all":c="selected";break;case "landscape":k="selected";break;case "portrait":p="selected";break;case "phone":f="selected"}h=h+(l+g)+'</div><div class="tdc-tab-responsive">';h+='<div class="tdc-responsive-buttons">';h+='<div class="tdc-responsive-all '+c+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';
"Newspaper"===window.tdcAdminSettings.themeName&&(h+='<div class="tdc-responsive-tablet-landscape '+k+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');h+='<div class="tdc-responsive-tablet-portrait '+p+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';h+='<div class="tdc-responsive-phone '+f+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';h+="</div>";h+="</div>";h+='<div class="tdc-tab-content-wrap">';g=k=
l="";for(c=0;c<a.length;c++)f=tdcSidebarPanel._fixGroupName(a[c]),p=tdcUtil.makeSafeForCSS(f),f="tdc-tab-no-design","css"===p&&(f="tdc-tab-design"),0===c?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+p+'">',k='<div class="tdc-tab-content '+f+'" id="td-tab-'+p+'">',p=d.get("tag"),p=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,_.isUndefined(p)||d.has("presetValues")||(p=JSON.parse(window.atob(p)),_.isArray(p)&&1<p.length&&d.set("presetValues",p)),d.has("presetValues")&&
(p=d.get("presetValues"),g+=tdcSidebarPanel._addPresetValuesSelector(p,d))):_.isUndefined(n)||n!=="td-tab-"+p?g+='<div class="tdc-tab-content '+f+'" id="td-tab-'+p+'">':(l=k,g+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+p+'">'),g+=tdcSidebarPanel._bindGroupAndGetHtml(a[c],e,d),p=' data-model_id="'+d.cid+'" ',"vc_row"===d.attributes.tag?(g+='<div class="tdc-sidebar-row-buttons">',g+='<div class="tdc-sidebar-button tdc-sidebar-delete-row" '+p+' title="Delete the current selected Row">Delete Row</div>',
g+='<div class="tdc-sidebar-button tdc-sidebar-clone-row" '+p+' title="Make a copy of the current selected Row. The copy will appear below the current Row">Clone Row</div>',"dev"===window.tdcAdminSettings.deployMode&&(g+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+p+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>'),g+='<div class="tdc-sidebar-button tdc-sidebar-save-shortcode" '+p+' title="Save current row">SAVE ROW</div>',g+="</div>"):"vc_row_inner"===d.attributes.tag?
(g+='<div class="tdc-sidebar-row-buttons">',g+='<div class="tdc-sidebar-button tdc-sidebar-delete-inner-row" '+p+' title="Delete the current selected Inner Row">Delete Inner Row</div>',g+='<div class="tdc-sidebar-button tdc-sidebar-clone-inner-row" '+p+' title="Make a copy of the current selected Inner Row. The copy will appear below the current Inner Row">Clone Inner Row</div>',g+='<div class="tdc-sidebar-button tdc-sidebar-save-shortcode" '+p+' title="Save current row">SAVE INNER ROW</div>',g+=
"</div>"):"vc_column"!==d.attributes.tag&&"vc_inner_column"!==d.attributes.tag&&(g+='<div class="tdc-sidebar-row-buttons">',"dev"===window.tdcAdminSettings.deployMode&&(g+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+p+' title="Get the current styles\' settings">CONSOLE: style presets</div>'),g+='<div class="tdc-sidebar-button tdc-sidebar-save-shortcode" '+p+' title="Save current row">SAVE SHORTCODE</div>',g+="</div>"),g+="</div>";h=h+(l+g)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(h);
...
break;case "23":a.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),a.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})()}},_bindGroupAndGetHtml:function(d,b,e){for(var a="",c=e.get("attrs"),h=0;h<b.params.length;h++){var f=b.params[h].param_name,g=b.params[h].group;if(d===tdcSidebarPanel._defaultGroupName&&
_.isEmpty(b.params[h].group)||b.params[h].group===d)a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[h],e);if("block_template_id"===f){g=c.block_template_id;_.isEmpty(g)&&(g=window.tdcAdminSettings.globalBlockTemplate);f=window.tdcAdminSettings.mappedBlockTemplates;for(var l=0;l<f[g].params.length;l++)if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(f[g].params[l].group)||f[g].params[l].group===d)a+=tdcSidebarPanel._bindParamAndGetHtml(f[g].params[l],e)}else if(0===f.indexOf("tds_")){var k=f.split("-");
l=k[0];var m;2===k.length?m=k[1]:2<k.length&&new tdcNotice.notice('Param "'+f+'" must have up to at most one "-" separator ',!0,!1);f=c[f];_.isEmpty(f)&&(f=window.tdcAdminSettings.globalStyle[l]);k=window.tdcAdminSettings.settingsStyle[l];for(l=0;l<k[f].params.length;l++)if(g==d||_.isUndefined(g)&&d===tdcSidebarPanel._defaultGroupName){var p=JSON.parse(JSON.stringify(k[f].params[l]));p.param_name=f+"-"+p.param_name;_.isUndefined(m)||(p.param_name+="-"+m);a+=tdcSidebarPanel._bindParamAndGetHtml(p,
...
case "Ajax filter":return"Ajax"}return d},clearPanel:function(){tdcSidebarPanel._deletePanel()},_addPresetValuesSelector:function(d,b){var e='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div>'+('<ul class="tdc-preset-values-list" data-model_id="'+b.cid+'">');for(var a=1;a<d.length;a++)e+='<li data-values="'+window.btoa(JSON.stringify(d[a]))+'">'+d[a].tdc_preset_name+
"</li>";e+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackPresets);return e},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});jQuery(".tdc-preset-values-list > li").click(function(){var d=jQuery(this),b=d.parent(".tdc-preset-values-list");d=JSON.parse(window.atob(d.data("values")));var e=tdcIFrameData.getModel(b.data("model_id")),
a={};_.isObject(d)&&(_.map(d,function(c,b){var d=!1;_.map(window.tdcAdminSettings.mappedShortcodes[e.get("tag")].params,function(e,f){e.param_name===b&&(d=!0,a[b]=c)});d||0!==b.indexOf("tds_")||(a[b]=c)}),e.set("attrs",a));tdcSidebarController.onUpdate(e);setTimeout(function(){tdcSidebar.setSettings({$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},
!0)},500)})},addColorpicker:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,
b)+'"/>');a+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackColorPicker)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackColorPicker);return a},callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-colorpicker-wrap");_.isUndefined(b.val())||""===b.val()||d.attr("style","background: "+
b.val())})},addGradient:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div>'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,
b)+'"/>');a+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return a},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-gradient-wrap");if(!_.isUndefined(b.val())&&""!==b.val())try{var e=JSON.parse(window.atob(b.val()));_.isUndefined(e.css)||
d.attr("style",e.css)}catch(a){e=b.val(),_.isUndefined(e)||d.attr("style","background: "+e)}})},addDropDown:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",h="",f=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&f.length<=parseInt(d.tdc_min_options))return c;for(var g=0;g<f.length;g++){var l=!1,k="",m=f[g],p=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),q=String(d.value[f[g]]);
_.isObject(d.value[f[g]])&&(l=!0,q=_.values(d.value[f[g]])[0],m=_.keys(d.value[f[g]])[0]);if(e||a){0===g&&""===p&&(p=q);p===q&&(k=" checked ");p=_.uniqueId();var r=q;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)r="col_"+r;h+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+p+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+k+' value="'+q+'">';e?(k="",l&&(k="tdc-standard-value"),h+='<label class="tdc-property-input-radio-label '+
k+'" for="'+p+'" title="'+m+'"><div class="'+r+'"></div></label>'):h+='<label class="tdc-property-input-radio-label" for="'+p+'" title="'+m+'">'+q+"</label>"}else p===q&&(k=' selected="selected" '),h+="<option "+k+' value="'+q+'">'+m+"</option>"}f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+f+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||
a?c+=h:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+h+"</select>");return c+"</div></div>"},addDropDownResponsive:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",h="",f=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&f.length<=parseInt(d.tdc_min_options))return c;var g=' data-responsive="" ',l=String(tdcSidebarPanel._getParameterCurrentValue(d,
b));try{var k=JSON.parse(window.atob(l));g=' data-responsive="'+l+'" ';"undefined"!==typeof k[tdcSidebar.currentViewportSettings.name]&&(l=k[tdcSidebar.currentViewportSettings.name])}catch(t){}for(k=0;k<f.length;k++){var m=!1,p="",q=f[k],r=String(d.value[f[k]]);_.isObject(d.value[f[k]])&&(m=!0,r=_.values(d.value[f[k]])[0],q=_.keys(d.value[f[k]])[0]);if(e||a){0===k&&""===l&&(l=r);l===r&&(p=" checked ");var w=_.uniqueId(),u=r;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+
u;h+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+w+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+p+' value="'+r+'">';e?(p="",m&&(p="tdc-standard-value"),h+='<label class="tdc-property-input-radio-label '+p+'" for="'+w+'" title="'+q+'"><div class="'+u+'"></div></label>'):h+='<label class="tdc-property-input-radio-label" for="'+w+'" title="'+q+'">'+r+"</label>"}else l===r&&(p=' selected="selected" '),h+="<option "+p+' value="'+
r+'">'+q+"</option>"}f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+f+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';c+='<div class="tdc-property">';e||a?c+=h:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" '+g+f+">",c=c+h+"</select>");return c+"</div></div>"},addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="checkbox" value="yes" '+a+"/>");return c+"</div></div>"},addCheckBoxResponsive:function(d,b){var e="",a=' data-responsive="" ',c=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var h=JSON.parse(window.atob(c));a=' data-responsive="'+c+'" ';"undefined"!==typeof h[tdcSidebar.currentViewportSettings.name]&&(c=h[tdcSidebar.currentViewportSettings.name])}catch(f){}""!==c&&(e=" checked ");h="";_.has(d,"description")&&""!==d.description&&(h=' title="'+d.description+'" ');c='<div class="tdc-property-responsive '+
tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+h+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+e+a+"/>");return c+"</div></div>"},addRange:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&
(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var h="";_.has(d,"range_step")&&""!==d.range_step&&(h=d.range_step);var f="";_.has(d,"value")&&""!==d.value&&(f=d.value);var g="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(g=tdcSidebarPanel._getParameterCurrentValue(d,b));var l='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';l+='<div class="tdc-property-title"><span'+
e+">"+d.heading+"</span></div>";l=l+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+g+'" data-min="'+c+'" data-max="'+a+'" data-step="'+h+'" min="'+c+'" max="'+a+'" step="'+h+'" value="'+g+'" />');return l=l+('<input type="text" class="tdc_range_value" data-default_value="'+f+'" value="'+g+'"/>')+"</div></div>"},addRangeResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&
(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var h="";_.has(d,"range_step")&&""!==d.range_step&&(h=d.range_step);var f="";_.has(d,"value")&&""!==d.value&&(f=d.value);""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&tdcSidebarPanel._getParameterCurrentValue(d,b);var g="";_.has(d,"placeholder")&&""!==d.placeholder&&(g=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+
'" ');var l=' data-responsive="" ',k=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var m=JSON.parse(window.atob(k));l=' data-responsive="'+k+'" ';k="undefined"===typeof m[tdcSidebar.currentViewportSettings.name]?"":m[tdcSidebar.currentViewportSettings.name]}catch(p){}m='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';m+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";m=m+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,
b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+k+'" data-min="'+c+'" data-max="'+a+'" data-step="'+h+'" min="'+c+'" max="'+a+'" step="'+h+'" value="'+k+'" '+l+" />");return m=m+('<input type="text" class="tdc_range_value" data-default_value="'+f+'" '+g+' value="'+k+'"/>')+"</div></div>"},addRangeMultiple:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,
b),h="",f="",g=[],l="",k="",m="",p="",q="",r="",w="",u;for(u in a)a.hasOwnProperty(u)&&(g.push(a[u].unit),""===k||""===l)&&(p=a[u].unit,k=' data-range_unit="'+p+'" ',m=a[u].value,l=' data-range_value="'+m+'" ',q=a[u].range_min,r=a[u].range_max,w=a[u].range_step);if(""!==c){for(var t=[],v=0;v<g.length&&!(t=c.split(g[v]),1<t.length);v++);t.length&&(p=g[v],k=' data-range_unit="'+p+'" ',m=t[0],l=' data-range_value="'+m+'" ')}for(u in a)a.hasOwnProperty(u)&&(c=_.uniqueId(),h+=" data-value_"+u+'="'+a[u].value+
'" ',h+=" data-min_"+u+'="'+a[u].range_min+'" ',h+=" data-max_"+u+'="'+a[u].range_max+'" ',h+=" data-step_"+u+'="'+a[u].range_step+'" ',g=a[u].value,t="",a[u].unit===p&&(g=m,q=a[u].range_min,r=a[u].range_max,w=a[u].range_step,t="checked"),f+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+u+'" data-unit_value="'+a[u].unit+'" type="radio" id="'+c+'" '+t+' data-default_value="'+a[u].value+'" data-last_value="'+g+'"/>',f+='<label for="'+c+'">'+a[u].unit+"</label>");a='<div class="'+
tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+l+" "+k+" "+h+' min="'+q+'" max="'+r+'" step="'+w+'" value="'+m+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+f+"</div>"+('<input type="text" class="tdc_range_value" value="'+
m+'"/>');a+="</div>";a+="</div>";return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),h="",f="",g=[],l=' data-responsive="" ',k="",m="",p="",q="",r="",w="",u="",t;for(t in a)a.hasOwnProperty(t)&&(g.push(a[t].unit),""===m||""===k)&&(q=a[t].unit,m=' data-range_unit="'+q+'" ',p=a[t].value,k=' data-range_value="'+p+'" ',r=a[t].range_min,w=a[t].range_max,
u=a[t].range_step);if(""!==c){var v=c;try{var A=JSON.parse(window.atob(c));l=' data-responsive="'+c+'" ';v="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(x){}if(""!==v){c=[];for(A=0;A<g.length&&!(c=v.split(g[A]),1<c.length);A++);c.length&&(q=g[A],m=' data-range_unit="'+q+'" ',p=c[0],k=' data-range_value="'+p+'" ')}}for(t in a)a.hasOwnProperty(t)&&(g=_.uniqueId(),h+=" data-value_"+t+'="'+a[t].value+'" ',h+=" data-min_"+t+'="'+a[t].range_min+
'" ',h+=" data-max_"+t+'="'+a[t].range_max+'" ',h+=" data-step_"+t+'="'+a[t].range_step+'" ',v=a[t].value,c="",a[t].unit===q&&(v=p,r=a[t].range_min,w=a[t].range_max,u=a[t].range_step,c="checked"),f+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+t+'" data-unit_value="'+a[t].unit+'" type="radio" id="'+g+'" '+c+' data-default_value="'+a[t].value+'" data-last_value="'+v+'"/>',f+='<label for="'+g+'">'+a[t].unit+"</label>");a='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+k+" "+m+" "+h+" "+l+' min="'+r+'" max="'+w+'" step="'+u+'" value="'+p+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+f+"</div>"+('<input type="text" class="tdc_range_value" value="'+p+'"/>');a+="</div>";
a+="</div>";return a+="</div>"},addIconSelector:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<div class="tdc-icon-wrap tdc-no-icon-selected" '+tdcSidebarPanel._getParamterDataAtts(d,b)+">");a+='</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div></div>';
tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(a,e){var c=jQuery(e);if(d.param_name===c.data("param_name")){var h=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==h&&(c.html('<i class="'+h+'"></i>'),c.closest(".tdc-property").find(".tdc-icon-remove").removeClass("tdc-hidden-button"))}})});return a},addUploadImage:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<div class="tdc-image-wrap tdc-no-image-selected" '+tdcSidebarPanel._getParamterDataAtts(d,b)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");a+='</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,
e){var c=jQuery(e);if(!c.parent().parent(".tdc-bg-upload").length&&d.param_name===c.data("param_name")){var h=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==h&&jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_url","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:h,action:"tdc_ajax_get_image_url"}}).done(function(a,b,e){"success"===b&&(_.isObject(a)&&
_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),c.data("image_link",a.image_url),c.data("image_id",h),c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,c,b){})}})});return a},addTextField:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+
d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var h='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';h+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";h=h+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" '+c+' value="'+
tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');return h=h+a+"</div></div>"},addTextFieldResponsive:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var h=' data-responsive="" ',f=tdcSidebarPanel._getParameterCurrentValue(d,
b);try{var g=JSON.parse(window.atob(f));h=' data-responsive="'+f+'" ';f="undefined"===typeof g[tdcSidebar.currentViewportSettings.name]?"":g[tdcSidebar.currentViewportSettings.name]}catch(l){}g='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';g+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";g=g+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" value="'+
f+'" '+c+h+e+"/>");return g=g+a+"</div></div>"},addTextAreaHtml:function(d,b){_.has(d,"description");return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+b.cid+'" data-mapped_parameter_name="'+d.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(d,b){var e=_.uniqueId("tdc_textarea_"),a="";_.has(d,"description")&&""!==d.description&&(a=' title="'+d.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+a+">"+
d.heading+"</span></div>";c=c+'<div class="tdc-property">'+('<textarea id="'+e+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(d,b)+">"+tdcSidebarPanel._getParameterCurrentValue(d,b)+"</textarea>");c+="</div></div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,
action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(d,b)}}).done(function(a,c,b){"success"===c&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):jQuery("#"+e).html(a.parsed_content).addClass("tdc-textarea-visible"))}).fail(function(a,c,b){});jQuery("body").on("keyup","#"+e,function(a){a=jQuery(a.target);var c=tdcIFrameData.getModel(a.data("model_id")),b=window.btoa(encodeURIComponent(a.val()));tdcSidebarController.onUpdate(c,a.data("param_name"),
b,b)});return c},addSeparatorHorizontal:function(d,b){return'<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(d)+'"></div>'},addTextSeparatorHorizontal:function(d,b){return'<div class="tdc-sidebar-text-separator tdc-property-title '+tdcSidebarPanel._getParameterClasses(d)+'"><span>'+d.heading+"</span></div>"},addFontHeader:function(d,b){return'<div class="tdc-sidebar-font-header '+tdcSidebarPanel._getParameterClasses(d)+'"><span class="tdc-font-ico1" title="Font size"></span><span class="tdc-font-ico2" title="Line height (Use with px or a number that will be multiplied with the current font-size)"></span><span class="tdc-font-ico3" title="Font style"></span><span class="tdc-font-ico4" title="Font weight"></span><span class="tdc-font-ico5" title="Text transform"></span><span class="tdc-font-ico6" title="Letter spacing"></span></div>'},
...
b),e.addClass("tdc-css-inherited"))):(d.val(b),c.val(b),e.removeClass("tdc-css-inherited"))}else if(e.hasClass("tdc-property-range_multiple-responsive")){a=tdcIFrameData.getModel(d.data("model_id"));var h=d.data("param_name"),f=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];a=[];for(var g=c="",l=0;l<f.params.length;l++)if(h===f.params[l].param_name){h=f.params[l].tdc_values;for(var k in h)h.hasOwnProperty(k)&&(a.push(h[k].unit),""===c||""===g)&&(c=h[k].value,g=h[k].unit);break}_.isUndefined(b)?
(b=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),_.isUndefined(b)&&(d.data("range_value",c),d.data("range_unit",g),d.val(c),k=e.find('input[type="radio"][data-unit_value="'+g+'"]'),l=k.data("unit"),h=d.data("min_"+l),g=d.data("max_"+l),l=d.data("step_"+l),f=d.get(0),k.prop("checked",!0),f.min=h,f.max=g,f.step=l,f.value=c,k.data("last_value",c),e.find('input[type="text"]').val(c)),"all"===tdcSidebar.currentViewportSettings.name?e.removeClass("tdc-css-inherited"):e.addClass("tdc-css-inherited")):
e.removeClass("tdc-css-inherited");if(!_.isUndefined(b)){c=[];for(l=0;l<a.length&&!(c=b.split(a[l]),1<c.length);l++);c.length&&(c=c[0],g=a[l],d.data("range_value",c),d.data("range_unit",g),d.val(c),k=e.find('input[type="radio"][data-unit_value="'+g+'"]'),l=k.data("unit"),h=d.data("min_"+l),g=d.data("max_"+l),l=d.data("step_"+l),f=d.get(0),k.prop("checked",!0),f.min=h,f.max=g,f.step=l,f.value=c,k.data("last_value",c),e.find('input[type="text"]').val(c))}}}}})();var tdcSidebar;
...
a=b.get("tag"),c="<span>"+window.tdcPostSettings.shortcodes[b.get("tag")]+"</span>",h="",f;for(f in window.tdcAdminSettings.mappedShortcodes)if("undefined"!==typeof window.tdcAdminSettings.mappedShortcodes[f].tdc_category&&("Blocks"===window.tdcAdminSettings.mappedShortcodes[f].tdc_category||"Big Grids"===window.tdcAdminSettings.mappedShortcodes[f].tdc_category)&&window.tdcAdminSettings.mappedShortcodes[f].tdc_category===window.tdcAdminSettings.mappedShortcodes[a].tdc_category){var n="";f===a&&(n=
"tdc-selected-option");h+='<li class="'+n+'" data-block_type="'+window.tdcAdminSettings.mappedShortcodes[f].base+'"><div class="tdc-element-ico tdc-ico-'+window.tdcAdminSettings.mappedShortcodes[f].base+'"></div><div class="tdc-element-id">'+window.tdcAdminSettings.mappedShortcodes[f].name+"</div></li>"}""!==h?(h="<ul>"+h+"</ul>",tdcSidebar.$_currentElementHead.addClass("tdc-block-selection")):tdcSidebar.$_currentElementHead.removeClass("tdc-block-selection");switch(a){case "vc_row":tdcSidebar.$_editRow.hide();
tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();var l=tdcSidebar.$_editRow;break;case "vc_column":tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();l=tdcSidebar.$_editColumn;break;case "vc_row_inner":tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();l=tdcSidebar.$_editInnerRow;break;case "vc_column_inner":tdcSidebar.$_editRow.show();
tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.show();tdcSidebar.$_editInnerColumn.hide();l=tdcSidebar.$_editInnerColumn;break;default:tdcSidebar.$_editRow.show(),tdcSidebar.$_editColumn.show(),l=tdcSidebar.getCurrentElement(),"vc_column_inner"===b.get("parentModel").get("tag")?(tdcSidebar.$_editInnerRow.show(),tdcSidebar.$_editInnerColumn.show()):(tdcSidebar.$_editInnerRow.hide(),tdcSidebar.$_editInnerColumn.hide())}tdcSidebar.$_currentElementHead.html(c);tdcSidebar.$_currentElementSiblings.html(h);
tdcSidebar.$_sidebar.find(".tdc-responsiveness").addClass(a);tdcSidebar.$_currentElementHead.off().mouseenter(function(a){a.preventDefault();l.trigger(a)}).mouseleave(function(a){a.preventDefault();l.trigger(a)}).click(function(a){""!==h&&(tdcSidebar.$_currentElementSiblings.toggleClass("tdc-current-element-siblings-visible"),a=g(this),tdcSidebar.$_currentElementSiblings.hasClass("tdc-current-element-siblings-visible")?a.addClass("tdc-current-element-siblings-button-on"):a.removeClass("tdc-current-element-siblings-button-on"))});
...
0;c<a.params.length;c++)if(a.params[c].param_name===b)return a.params[c];if(0===b.indexOf("tds_")){c=b.split("-");var h=e=g;a=g;2>c.length?new tdcNotice.notice('Param "'+b+'" must have up at least one "-" separator',!0,!1):2===c.length?e=c[0]:3===c.length?(e=c[0],a=c[2]):3<c.length&&new tdcNotice.notice('Param "'+b+'" must have up to at most two "-" separator',!0,!1);if(_.isUndefined(h))for(var f in window.tdcAdminSettings.settingsStyle){if(!_.isUndefined(h))break;for(var n in window.tdcAdminSettings.settingsStyle[f])if(n===
e){h=f;break}}_.isUndefined(e)&&(e=window.tdcAdminSettings.globalStyle[h]);f=window.tdcAdminSettings.settingsStyle[h][e];for(c=0;c<f.params.length;c++)if(n=e+"-"+f.params[c].param_name,_.isUndefined(a)||(n+="-"+a),n===b)return d=JSON.parse(JSON.stringify(f.params[c])),d.param_name=e+"-"+d.param_name,_.isUndefined(a)||(d.param_name+="-"+a),d}new tdcNotice.notice("Map value not found for "+d+" "+b,!0,!1);return g},onUpdate:function(d,b,e,a){var c=new tdcSidebarController._updateJob;c.model=d;c.paramName=
b;c.oldValue=e;c.value=a;tdcSidebarController._addToBuffer(c)},_addToBuffer:function(d){tdcSidebarController.updateJobBuffer[d.model.get("blockUid")]=d;""!==tdcSidebarController.updateJobTimer&&clearTimeout(tdcSidebarController.updateJobTimer);tdcSidebarController.updateJobTimer=setTimeout(function(){1<tdcSidebarController.updateJobBuffer.length&&(console.log("Multiple jobs detected - see below"),console.log(tdcSidebarController.updateJobBuffer));for(var b in tdcSidebarController.updateJobBuffer)tdcSidebarController._doUpdateJob(tdcSidebarController.updateJobBuffer[b]);
tdcSidebarController.updateJobBuffer={};tdcSidebarController.updateJobTimer=""},500)},_doUpdateJob:function(d){if(!_.isUndefined(d.paramName)){var b=d.model.get("attrs"),e=_.clone(b);b=tdcSidebarController._getParamMap(d.model.attributes.tag,d.paramName,b);b.value===d.value?delete e[b.param_name]:e[b.param_name]=d.value;d.model.set("attrs",e)}e={error:g,getShortcode:""};tdcIFrameData._checkModelData(d.model,e);if(!_.isUndefined(e.getShortcode)){var a=d.model.get("blockUid"),c=new tdcJobManager.job;
c.shortcode=e.getShortcode;c.columns=tdcIFrameData.getColumnNumber(d.model);c.blockUid=a;parseInt(d.model.get("level"),10);d.model.set("bindNewContent",!0);c.success_callback=function(b){var e=tdcAdminIFrameUI.getIframeWindow();tdcIFrameData.deleteCallback(d.model);d.model.set("blockUid",b.blockUid);_.has(b,"replyHtml")&&(d.model.set("shortcode",c.shortcode),d.model.set("html",b.replyHtml));_.has(b,"replyJsForEval")&&(e.tdcEvalGlobal={oldBlockUid:a},tdcAdminIFrameUI.evalInIframe(b.replyJsForEval))};
...
g(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");g(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(b){var e=g("img",b).attr("src"),h="";"undefined"===typeof e?(e=g(b).attr("src"),h=g(b).attr("class")):h=g("img",b).attr("class");g.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
dataType:"json",data:{image_class:h,action:"tdc_ajax_get_image_id"}}).done(function(b,f,h){if("success"===f)if(d.isObject(b)&&d.has(b,"errors"))new tdcNotice.notice(b.errors,!0,!1);else{f=a.closest(".tdc-property-wrap");h=f.find(".tdc-css-image-remove");var g=f.find(".tdc-inherit-image");h.removeClass("tdc-hidden-button");"all"===tdcSidebar.currentViewportSettings.name?g.hide():g.show();a.attr("style","background-image: url( '"+e+"') ");a.data("image_link",e);a.data("image_id",b.image_id);window.send_to_editor=
...
c=a.val();var f=1;a.hasClass("tdc-css-opacity")&&(f=.01);var n=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:g.isNumeric(c)&&(n=parseFloat(c)+f);break;case 40:g.isNumeric(c)&&(n=parseFloat(c)-f)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),g.isNumeric(c)&&(n=0<b.originalEvent.deltaY?parseFloat(c)-f:parseFloat(c)+f)}d.isNaN(n)||(1>f&&(n=n.toFixed(2)),a.val(n));tdcCssEditor._updateData(a);c=e.data("tdc-for");b={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,
...
a+'"></div>'),g("body").append(c),c.find("input").on("input",function(a){var b=g(this),e=tdcAdminIFrameUI.getLiveIframe(),h=b.data("scroll-bar-width");c.find("output").html(b.val());tdcCssEditor.timeoutMediaInterval=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutMediaInterval)||clearTimeout(tdcCssEditor.timeoutMediaInterval);e.css("width",parseInt(b.val())+parseInt(h))},200)}));""===b?c.hide():(c.show(),tdcCssEditor.timeoutIframeHtml=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutIframeHtml)||
...
e){var c=g(e),h=c.closest(".tdc-property-wrap"),l=h.find(".tdc-css-image-remove"),k=h.find(".tdc-inherit-image"),m={isInherited:!1},p=tdcCssEditor._getSettingsProperty("background-image",b,m);m.isInherited?h.addClass(tdcCssEditor._INHERITED_CSS_CLASS):h.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);d.isUndefined(p)?(l.addClass("tdc-hidden-button"),k.hide()):("no_value"===p?l.addClass("tdc-hidden-button"):(l.removeClass("tdc-hidden-button"),c.attr("style",'background-image: url("'+p+'")')),"all"!==
tdcSidebar.currentViewportSettings.name&&k.show());c.data("image_link",p)});g(".tdc-inherit").each(function(a,e){var c=g(e),h=c.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||h.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))c.hide();else{var l=h.data("tdc-for");h={isInherited:!1};l=tdcCssEditor._getSettingsProperty(l,b,h);h.isInherited?c.hide():d.isUndefined(l)||c.show()}})});return tdcCssEditor.generateEditorResponsiveContent()},_cleanCss:function(e,a){if("undefined"===
...
a+'"':""}function c(){return l.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function h(a,b){var h=tdcCssEditor._getSettingsProperty(a,b,e()),g="-",k="";l.isInherited&&(g=h,h="");d.isUndefined(n)||"margin-left"!==a&&"margin-right"!==a||(k=n.get("tag"),k="vc_column"===k||"vc_column_inner"===k?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+h+'" class="tdc-css-box-input tdc-css-box-input-'+a+c()+k+'" title="Css '+a+'" placeholder="'+g+
'" '+tdcSidebarPanel._getParamterDataAtts(f,n)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var f=tdcCssEditor._mappedParameter,n=tdcCssEditor._model,l={isInherited:!1};var k='<div class="tdc-responsiveness">'+('<div class="'+tdcSidebarPanel._getParameterClasses(f)+'">');k=k+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+h("margin-top","");k+=h("margin-right","");k+=h("margin-bottom","");k+=h("margin-left","");k=k+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
h("border-top-width","");k+=h("border-right-width","");k+=h("border-bottom-width","");k+=h("border-left-width","");k=k+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+h("padding-top","");k+=h("padding-right","");k+=h("padding-bottom","");k+=h("padding-left","");k+="</div></div></div></div>";var m=tdcCssEditor._getSettingsProperty("border-style",b,e());k+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+c()+'" data-tdc-for="border-style">';k=k+'<div class="tdc-property-title"><span title="Css border-style">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-border-style" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},
{value:"inherit",display:"Inherit"}],m);k+="</select></div></div>";m=d.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",e()),q="";l.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';k=k+'<div class="tdc-property-title"><span title="Css border-color">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(f,n)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+a(q)+' value="'+p+'"/>');k+="</div></div>";m=tdcCssEditor._getSettingsProperty("border-radius","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';k=k+'<div class="tdc-property-title"><span title="Css border-radius">Border radius</span></div><div class="tdc-property">'+
('<input class="tdc-css-border-radius" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("width","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-width tdc-textfield-small'+c()+'" data-tdc-for="width">';k=k+'<div class="tdc-property-title"><span title="Css shadow-size">Width</span></div><div class="tdc-property">'+
('<input class="tdc-css-width" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("shadow-size","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';k=k+'<div class="tdc-property-title"><span title="Css shadow-size">Shadow size</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-size" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+="</div></div>";m=d.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";l.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';k=k+'<div class="tdc-property-title"><span title="Css shadow-color">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(f,n)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+a(q)+' value="'+p+'"/>');k+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';k=k+'<div class="tdc-property-title"><span title="Css shadow-offset-h">Shadow offset H</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-offset-h" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';k=k+'<div class="tdc-property-title"><span title="Css shadow-offset-v">Shadow offset V</span></div><div class="tdc-property">'+('<input class="tdc-css-shadow-offset-v" '+
tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=d.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",e());q="";l.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';k=k+'<div class="tdc-property-title"><span title="Css background-color">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(f,n)+tdcCssEditor._getDataNoValue(p)+' id="'+m+'" name="" type="text" '+a(q)+' value="'+p+'"/>');k+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",b,e());k+='<div class="tdc-property-wrap tdc-property-attach_image'+c()+'">';k=k+'<div class="tdc-property-title"><span title="Css background-image">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property">'+
('<div class="tdc-css-bg-image tdc-css-image-wrap " '+tdcSidebarPanel._getParamterDataAtts(f,n)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");k+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';m=tdcCssEditor._getSettingsProperty("background-style",b,e());k+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+c()+'" data-tdc-for="background-style">';k=k+'<div class="tdc-property-title"><span title="Css background-size & background-repeat">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-style" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],m);k+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("background-position",b,e());k+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="background-position">';k=k+'<div class="tdc-property-title"><span title="Css background-position">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-position" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",
display:"Right Bottom"}],m);k+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("opacity","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';k=k+'<div class="tdc-property-title"><span title="Css background-image opacity">Background opacity</span></div><div class="tdc-property">'+('<input class="tdc-css-opacity" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');
k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",e());q="";l.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';k=k+'<div class="tdc-property-title"><span title="Css gradient color From">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(f,n)+tdcCssEditor._getDataNoValue(p)+' id="'+m+'" name="" type="text" '+a(q)+' value="'+p+'"/>');k+="</div></div>";m=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",e());q="";l.isInherited&&(q=p,p="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';k=k+'<div class="tdc-property-title"><span  title="Css gradient color To">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(f,n)+tdcCssEditor._getDataNoValue(p)+' id="'+m+'" name="" type="text" '+a(q)+' value="'+p+'"/>');k+="</div></div>";m=tdcCssEditor._getSettingsProperty("gradient-direction","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';k=k+'<div class="tdc-property-title"><span title="Css gradient direction">Gradient direction</span></div><div class="tdc-property">'+
('<input class="tdc-css-gradient-direction" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=tdcCssEditor._getSettingsProperty("content-h-align",b,e());k+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';k=k+'<div class="tdc-property-title"><span title="Css content horizontal align">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-content-h-align" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],m);k+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("z-index","",e());p="";l.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';
k=k+'<div class="tdc-property-title"><span title="Z-index">Z-index</span></div><div class="tdc-property">'+('<input class="tdc-css-z-index" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+="</div></div>";m=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);k+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';k=k+'<div class="tdc-property-title"><span title="Css content horizontal align">Display</span></div><div class="tdc-property">'+
('<select class="tdc-css-display" '+tdcSidebarPanel._getParamterDataAtts(f,n)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"}],m);k=k+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>'+('<div class="tdc-clear-css-properties" '+
tdcSidebarPanel._getParamterDataAtts(f,n)+' title="Clear all tab css settings">Clear CSS settings</div>');k+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){g(".tdc-inherit").each(function(a,c){var e=g(c),f=e.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||f.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))e.hide();else{var h=f.data("tdc-for");f={isInherited:!1};h=tdcCssEditor._getSettingsProperty(h,
b,f);f.isInherited?e.hide():d.isUndefined(h)||e.show()}})});return k},_getAvailableViewportSetting:function(b,a,c){if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d;switch(b){case "all":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]&&(d="all");break;case "landscape":case "portrait":case "phone":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]?d=b:"undefined"!==typeof tdcCssEditor._currentCssSettings.all&&(d="all")}if("undefined"!==typeof d){if("undefined"!==typeof tdcCssEditor._currentCssSettings[d][a])return tdcSidebar.currentViewportSettings.name!==
...
g=!1,l=0,k=0;k<b.length;k++)d.isUndefined(c)||c!==b[k].value||(l=k),f="",d.isUndefined(a)||a!==b[k].value||(f='selected="selected"',g=!0),e.push("<option "+f+' value="'+b[k].value+'">'+b[k].display+"</option>");g||(e[l]='<option selected="selected" value="'+b[l].value+'">'+b[l].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),
g=b.find(".tdc-css-box-input-margin-left").val().trim(),l=b.find(".tdc-css-box-input-border-top-width").val().trim(),k=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),r=b.find(".tdc-css-box-input-padding-right").val().trim(),w=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),
t=b.find(".tdc-css-border-radius").val().trim(),v=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-shadow-size").val().trim(),x=b.find(".tdc-css-shadow-offset-h").val().trim(),z=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim();""!==c&&(a["margin-top"]=c);""!==e&&(a["margin-right"]=e);""!==f&&(a["margin-bottom"]=f);""!==g&&(a["margin-left"]=g);""!==l&&(a["border-top-width"]=
l);""!==k&&(a["border-right-width"]=k);""!==m&&(a["border-bottom-width"]=m);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==r&&(a["padding-right"]=r);""!==w&&(a["padding-bottom"]=w);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=e);c=b.find(".tdc-css-border-color");e=c.val().trim();""!==e?a["border-color"]=e:(c=c.data("no_value"),d.isUndefined(c)||
1!==c||(a["border-color"]="no_value"));""!==t&&(a["border-radius"]=t);""!==v&&(a.width=v);""!==A&&(a["shadow-size"]=A);t=b.find(".tdc-css-shadow-color");v=t.val().trim();""!==v?a["shadow-color"]=v:(t=t.data("no_value"),d.isUndefined(t)||1!==t||(a["shadow-color"]="no_value"));""!==x&&(a["shadow-offset-h"]=x);""!==z&&(a["shadow-offset-v"]=z);x=b.find(".tdc-css-bg-color");z=x.val().trim();""!==z?a["background-color"]=z:(x=x.data("no_value"),d.isUndefined(x)||1!==x||(a["background-color"]="no_value"));
...
this.button.removeClass("hidden");this.wrap.addClass("wp-picker-active");this.toggler.addClass("wp-picker-open");this.element.tdPalette().get(0).init(a)}});"undefined"===typeof g.fn.tdGradient&&(g.fn.tdGradient=function(){return this.each(function(){var a=this,b=g(this);a.$this=b;if(!1!==b.data("rgba")){var h=g.cs_ParseColorValue(b.val());b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},change:function(c,d){var e=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",
e);b.val(e).trigger("change");a.triggerSelection?a.setColor(e,!0):a.setColor(e)},create:function(){var c=b.data("a8cIris"),n=b.closest(".wp-picker-container"),l=g('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(n.find(".wp-picker-holder")),k=l.find(".cs-alpha-slider"),m=l.find(".cs-alpha-text"),p=l.find(".cs-alpha-slider-offset"),q=g('<div class="tdc-gradient-result-wrap"></div>').prependTo(n);
q=g('<div class="tdc-gradient-result"><div class="tdc-gradient-color tdc-gradient-left-color"></div><div class="tdc-gradient-color tdc-gradient-right-color"></div></div>').prependTo(q);g('<div class="tdc-gradient-degree-label">deg.</div><input class="tdc-gradient-degree" placeholder="0">').appendTo(n.find(".wp-picker-input-wrap"));g('<div class="tdc-gradient-result-labels"><div class="tdc-gradient-result-label">Solid color</div><div class="tdc-gradient-result-label tdc-gradient-result-percentage"></div><div class="tdc-gradient-result-label">Gradient</div></div>').prependTo(n);
g('<div class="tdc-gradient-save">Save Gradient</div>').appendTo(n);var r=g('<div class="tdc-gradient-presets">Gradient presets</div>').appendTo(n),w=g('<div class="tdc-gradient-values-wrapper"></div>').appendTo(n);w=g('<div class="tdc-gradient-values"></div>').appendTo(w);if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.gradients&&d.tdcAdminSettings.tdcSavings.gradients.length)for(var u=!1,t=d.tdcAdminSettings.tdcSavings.gradients.length-1;0<=t;t--){var v=d.tdcAdminSettings.tdcSavings.gradients[t];
try{var A=JSON.parse(d.atob(v));"undefined"!==typeof A.css&&(u=!0,g('<div class="tdc-gradient-value" style="'+A.css+'" data-gradient="'+v+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(w))}catch(x){}}u||r.hide();a.$container=n;a.$gradientResult=q;k.slider({slide:function(a,d){var e=parseFloat(d.value/100);c._color._alpha=e;b.tdGradientColorPicker("color",c._color.toString());m.text(1>e?e:"")},create:function(){var d=parseFloat(h.alpha/100);m.text(1>d?d:"");p.css("background-color",
h.value);n.on("click",".wp-picker-clear",function(){c._color._alpha=1;m.text("");k.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});n.on("click",".wp-picker-default",function(){var a=g.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;m.text(1>d?d:"");k.slider("option","value",a.alpha).trigger("slide")});n.on("click",".wp-color-result",function(a){l.toggle()});g("body").on("click.wpcolorpicker",function(){l.hide()});
n.on("change keyup",".tdc-gradient-degree",function(b){b=g(this);a.degree=b.val().trim();a.mixedColors=a._getMixedColors();a._updateGradient();a._saveValue()})},value:h.alpha,step:1,min:0,max:100})}})}else b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},change:function(a,c){b.val(c.color.toString()).trigger("change")}});"undefined"===typeof a.setColor&&(a.setColor=function(b,c){"undefined"===typeof a.currentColor&&(a.currentColor="left",a.$gradientResult.find(".tdc-gradient-selected-color").remove(),
...
b.degree;a.setColor(a.color1);a.$this.tdGradientColorPicker("color",a.color1);a.mixedColors=b.mixedColors;if("undefined"!==typeof a.mixedColors)for(var f=0;f<a.mixedColors.length;f++){var h=g('<div class="tdc-gradient-color tdc-gradient-mix-color"></div>').appendTo(c),m=(c.width()-h.outerWidth(!0))*(100-a.mixedColors[f].percentage)/100;h.css("left",m);h.data("percentage",a.mixedColors[f].percentage);"undefined"!==typeof a.mixedColors[f].color&&h.data("color",a.mixedColors[f].color)}a._updateGradient()}catch(p){a.setColor(b),
...
this,b=g(this);a.$this=b;if(!1!==b.data("rgba")){var d=g.cs_ParseColorValue(b.val());b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(c,d){var e=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",e);b.val(e).trigger("change");a.triggerSelection?a.setColor(e,!0):a.setColor(e)},create:function(){var c=b.data("a8cIris"),h=b.closest(".wp-picker-container"),l=g('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(h.find(".wp-picker-holder")),
k=l.find(".cs-alpha-slider"),m=l.find(".cs-alpha-text"),p=l.find(".cs-alpha-slider-offset");a.$container=h;k.slider({slide:function(a,d){var e=parseFloat(d.value/100);c._color._alpha=e;b.tdPaletteColorPicker("color",c._color.toString());m.text(1>e?e:"")},create:function(){var f=parseFloat(d.alpha/100);m.text(1>f?f:"");p.css("background-color",d.value);h.on("click",".wp-picker-clear",function(){c._color._alpha=1;m.text("");k.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,
!0):a.setColor(e)});h.on("click",".wp-picker-default",function(){var a=g.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;m.text(1>d?d:"");k.slider("option","value",a.alpha).trigger("slide")});h.on("click",".wp-color-result",function(a){l.toggle()});g("body").on("click.wpcolorpicker",function(){l.hide()})},value:d.alpha,step:1,min:0,max:100})}})}else b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(a,c){b.val(c.color.toString()).trigger("change")}});
